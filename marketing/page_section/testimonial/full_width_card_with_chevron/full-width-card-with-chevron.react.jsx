    ...
    return (
        <div>
            <div className="container mx-auto pt-16">
                <h1 className="text-gray-800 font-extrabold xl:text-5xl text-3xl mb-4 text-center md:text-center lg:text-center">Hear From Our Customers</h1>
                <p className="text-xl text-center md:text-center xl:w-2/3 lg:w-2/3 w-11/12 mx-auto text-gray-600 mb-12">You made it so simple. My new site is so much faster and easier to work with than my old site. I just choose the page, make the change and click save.</p>
            </div>
                    ...
                    <section id="carousel">
                        <figure className={change ? "hidden" : "block"}>
                            <div className="w-11/12 mx-auto bg-white py-10 sm:px-16 px-10 relative">
                                <div className="flex items-center justify-between pb-8">
                                    <div className="xl:flex md:flex lg:flex sm:flex items-center">
                                        ...
                                        <div className="xl:pl-6 lg:pl-6 md:pl-6 sm:pl-6 sm:pt-0 pt-4">
                                            ...
                                            <p className="sm:text-xl text-sm text-gray-600">VP Operations, AlphaSquad</p>
                                        </div>
                                    </div>
                                ...
                                <p className="text-base text-gray-600 pb-6 w-full sm:w-10/12">I just wanted to share a quick note and let you know that you guys do a really good job. I’m glad I decided to work with you. It’s really great how easy your websites are to update and manage. I never have any problem at all.</p>
                                <p className="text-base text-gray-600 w-full sm:w-10/12">My new site is so much faster and easier to work with than my old site. It used to take me an hour or more to update a page and I would still sometimes screw things up.</p>
