        ...
        <div>
            ...
            <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40">
                <CarouselProvider naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={2}>
                    ...
                    <h1 className="text-5xl font-bold xl:hidden block leading-tight text-gray-800">What our customers are saying</h1>
                    <Slider>
                            ...
                            <div className="flex">
                                <div className="mt-14 md:flex">
                                    ...
                                    <div className="md:w-1/2 xl:ml-32 md:ml-20 md:mt-0 mt-4 flex flex-col justify-between">
                                        <div>
                                            <h1 className="text-2xl font-semibold lg:leading-loose text-gray-800">Some of the best work that was done!</h1>
                        ...
                        <Slide index={1}>
                            <div className="flex relative ">
                                <div className="mt-14 md:flex">
                                    ...
                                    <div className="md:w-1/2 xl:ml-32 md:ml-20 md:mt-0 mt-4 flex flex-col justify-between">
                                        <div>
                                            <h1 className="text-2xl font-semibold leading-loose text-gray-800">Some of the best work that was done!</h1>
                                            <p className="text-base font-medium leading-6 mt-4 text-gray-600">Our core values are at the heart of all that we do. They are integrated into our daily work lives and help us to remember our customers always comes first, the last thank you should always comes from us.</p>
                                        </div>
                                        <div className="md:mt-0 mt-8">
                                            <p className="text-base font-medium leading-4 text-gray-800">Anna Smith</p>
