<template>
    <body class="py-16 bg-gray-50">
        <div class="container mx-auto px-4 flex flex-col lg:items-center justify-between lg:flex-row">
            <div class="mb-14 xl:mb-0">
                <h1 class="text-2xl leading-tight md:text-4xl xl:text-5xl font-bold text-gray-800 xl:w-2/3 pr-16 lg:pr-0">Our customers love what we do</h1>
            ...
            <div role="list" aria-label="Testimonials" class="xl:w-1/2 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 flex-wrap justify-center items-start">
                <div role="listitem" class="bg-white shadow rounded p-4 xl:p-8">
                    ...
                    <div class="pl-4 pt-4 flex items-start justify-between">
                        <div class="mr-6">
                            <p class="xl:text-xl xl:leading-loose text-gray-600">This website has a bunch of amazing components which improves my design</p>
