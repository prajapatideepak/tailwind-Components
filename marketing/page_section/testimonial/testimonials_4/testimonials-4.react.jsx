        ...
        <>
            <div className="lg:px-20 md:px-6 px-4 py-12">
                <div className="flex flex-col items-center justify-center">
                    <h1 className="lg:text-5xl text-3xl font-bold text-center text-gray-800">Listen From Our Clients</h1>
                    <p className="text-base leading-6 mt-4 text-center text-gray-600 2xl:w-2/5 sm:w-96">Whether article spirits new her covered hastily sitting her. Money witty books nor son add</p>
                </div>
                        ...
                        <div className="bg-white border rounded-md border-gray-200 relative sm:p-10 p-6">
                            ...
                            <div className="absolute bottom-0 -mb-4 ml-10">
                                <svg width={23} height={22} viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M21.5 6L11.5 21L1 6" stroke="#E5E7EB" strokeLinecap="square" strokeLinejoin="round" />
                                </svg>
                            </div>
                        </div>
