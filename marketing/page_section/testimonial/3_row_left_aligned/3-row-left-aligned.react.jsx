...
function IndexPage() {
    return (
        <>
            <div className="bg-gray-100 px-4 xl:px-0 py-20">
                        ...
                        <div>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width={188} height={3} viewBox="0 0 188 3" fill="none">
                                    <line x1="9.1809e-05" y1="1.5" x2="187.922" y2="1.50003" stroke="#805AD5" strokeWidth={3} />
                                </svg>
                                <svg className="ml-3" xmlns="http://www.w3.org/2000/svg" width={14} height={13} viewBox="0 0 14 13" fill="none">
                                    <path d="M7.23776 1.92275L7 1.19098L6.76224 1.92275L5.69579 5.20492H2.24472H1.4753L2.09777 5.65717L4.88975 7.68566L3.82331 10.9678L3.58555 11.6996L4.20802 11.2473L7 9.21885L9.79198 11.2473L10.4145 11.6996L10.1767 10.9678L9.11025 7.68566L11.9022 5.65717L12.5247 5.20492H11.7553H8.30421L7.23776 1.92275Z" stroke="#805AD5" strokeWidth="0.5" />
                                </svg>
                            </div>
                            <h1 className="text-2xl lg:text-5xl lg:w-2/3 mt-8 tracking-wide font-bold text-gray-800">Reviews from Real Agency Owners</h1>
                            <p className="lg:w-8/12 text-gray-700 mt-5 mb-12">Always available, extremely knowledgeable, and with a tremendous "can-do" attitude. Our company was on a tight timeline and strict budget to create a first-class mobile interpretation app, and Will was the perfect partner. His guidance and advice were invaluable in producing that app which easily exceeded my expectations</p>
                        </div>
                        <div>
                            <div className="bg-white shadow-md lg:w-10/12 rounded-3xl">
                                <div className="py-8 px-10">
                                    <p className="tracking-wide text-gray-700 text-base leading-8 border-b border-gray-300 pb-4">Greatest appreciation to you and your team for the outstanding job you did for us. The website is just what we wanted, and we were thrilled with the speed your team exercised. </p>
                                    <div className="mt-4 lg:flex justify-between items-center">
                                        <div className="flex items-center">
                                            <div className>
                                                <img loading="lazy" className src="https://cdn.tuk.dev/assets/components/111220/Ts8/profile(1).png" alt="profile" srcSet />
                                            </div>
                                            <div className="ml-6">
                                                <h1 className="text-base font-semibold">Tony Stark</h1>
                                                <h2 className="text-indigo-600 font-light mt-2">December 2020</h2>
                                            </div>
                                        </div>
                            ...
                            <div className="bg-white mt-8 shadow-md lg:w-10/12 rounded-3xl">
                                <div className="py-8 px-10">
                                    <p className="tracking-wide text-gray-700 text-base leading-8 border-b border-gray-300 pb-4">Always available, extremely knowledgeable, and with a tremendous "can-do" attitude. Our company was on a tight timeline and strict budget to create a first-class mobile interpretation app, and Will was the perfect partner. His guidance and advice were invaluable in producing that app which easily exceeded my expectations.</p>
                                    <div className="mt-4 lg:flex justify-between items-center">
                                        <div className="flex items-center">
                                            <div className>
                                                <img loading="lazy" className src="https://cdn.tuk.dev/assets/components/111220/Ts8/profile(2).png" alt="profile" srcSet />
                                            </div>
                                            <div className="ml-6">
                                                <h1 className="text-base font-semibold">Tony Stark</h1>
                                                <h2 className="text-indigo-600 font-light mt-2">December 2020</h2>
                            ...
                            <div className="bg-white mt-8 shadow-md lg:w-10/12 rounded-3xl">
                                <div className="py-8 px-10">
                                    ...
                                    <div className="mt-4 lg:flex justify-between items-center">
                                        <div className="flex items-center">
                                            <div className>
                                                <img loading="lazy" className src="https://cdn.tuk.dev/assets/components/111220/Ts8/profile(3).png" alt="profile" srcSet />
                                            </div>
                                            <div className="ml-6">
                                                <h1 className="text-base font-semibold">Tony Stark</h1>
                                                <h2 className="text-indigo-600 font-light mt-2">December 2020</h2>
