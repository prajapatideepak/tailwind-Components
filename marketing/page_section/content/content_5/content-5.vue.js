<template>
  <body
    class="2xl:mx-auto 2xl:container 2xl:p-20 md:p-10 p-8 overflow-y-hidden"
  >
    <div>
      <img
        src="https://i.ibb.co/gynWGZF/puppy.png"
        alt="image of a dog"
        class="w-full md:block hidden"
      />
      <img
        src="https://i.ibb.co/LR8LRcK/tablet.png"
        alt="image of a dog"
        class="w-full h-80 object-cover object-center md:hidden"
      />
    </div>
    <div class="lg:px-28 md:px-20 lg:-mt-40 sm:-mt-28 -mt-28 relative z-30">
      <div
        class="
          bg-white
          shadow-md
        ...
        "
      >
        <h1 class="lg:text-5xl text-3xl font-bold text-gray-800 text-center">
        ...
        <p
          ...
          "
        >
          Using a motivational quote that speaks to you is a great way to start
          a journal page or begin your writing for the day. Just having that
          first quote to get the ideas going is an invaluable tool.
        </p>
        <div class="mt-10 flex lg:flex-row flex-col items-center">
          ...
          <div class="flex flex-col items-center justify-center lg:mt-0 mt-10">
            <div
              class="
                w-12
                h-12
