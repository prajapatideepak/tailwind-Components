<template>
    <div class="bg-gray-100 py-4 md:py-10">
            ...
            <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <div id="menu" class="md:block lg:block hidden">
                        <div onclick="toggleMenu(false)" class="block md:hidden lg:hidden text-gray-500 hover:text-gray-700 focus:text-gray-700 fixed focus:outline-none z-30 top-0 pt-6">
                        ...
                        <ul class="flex md:flex text-3xl md:text-base lg:text-base lg:flex flex-col md:flex-row lg:flex-row justify-center items-center fixed pb-10 md:relative lg:relative top-0 bottom-0 left-0 right-0 bg-gray-100 z-20">
                            ...
                            <li class="flex items-center">
                                <button class="focus:outline-none transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-indigo-600 text-indigo-600 px-6 py-3 text-sm mt-10 md:mt-0">Sign In</button>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row">
                ...
                <div class="mt-6 md:mt-0 h-64 md:h-auto md:w-1/2 relative lg:mt-0 pl-6 sm:pl-20 pt-10 flex justify-end sm:block">
                    <div class="ml-12 -mb-32 absolute left-0 w-5/6 h-full">
                        <img class="inset-0 absolute object-cover object-center z-10 shadow-md w-full h-full" src="https://tuk-cdn.s3.amazonaws.com/assets/components/hero/h_4.png" alt="Coffee" />
                    </div>
...
<script>
export default {
    name: "LeftAlignedWithImageAndCta",
    methods: {
