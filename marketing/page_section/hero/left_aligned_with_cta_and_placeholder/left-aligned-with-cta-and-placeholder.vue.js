                ...
                <div class="hidden lg:flex w-full f-f-p justify-between items-center py-6 relative">
                    <div class="w-2/3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="115" height="40" viewBox="0 0 115 40" fill="none">
                            <path d="M0 39.4521V12.0548H12.8311C18.8007 12.0548 22.0257 16.0959 22.0257 20.8904C22.0257 25.6849 18.7321 29.726 12.8311 29.726H5.83234V39.4521H0ZM16.1247 20.8904C16.1247 18.5617 14.4093 17.1918 12.0764 17.1918H5.83234V24.5891H12.0764C14.3407 24.5891 16.1247 23.1507 16.1247 20.8904Z" fill="#032E47"></path>
                            <path d="M25.6621 39.4521V12.0548H31.5631V39.4521H25.6621Z" fill="#032E47"></path>
                            <path d="M44.6688 39.4521C42.13 32.9452 39.5913 26.4384 37.1211 19.9315C40.895 24.3151 44.6002 28.6986 48.3741 33.1507C54.6181 22.0548 60.8621 11.0274 67.1748 0C62.0972 13.1507 57.0883 26.3014 52.0107 39.4521H44.6688Z" fill="#4B98D3"></path>
                            <path d="M44.6688 39.4521C42.13 32.9452 39.5913 26.4384 37.1211 19.9315C40.895 24.3151 44.6002 28.6986 48.3741 33.1507C49.6092 35.274 50.8442 37.3973 52.0107 39.4521H44.6688Z" fill="#032E47"></path>
                            <path d="M63.1953 25.8219C63.1953 17.5343 69.2335 11.6439 77.536 11.6439C85.8385 11.6439 91.8767 17.5343 91.8767 25.8219C91.8767 34.1096 85.8385 40 77.536 40C69.2335 40 63.1953 34.1096 63.1953 25.8219ZM85.9071 25.8219C85.9071 20.685 82.6136 16.8493 77.536 16.8493C72.4584 16.8493 69.2335 20.685 69.2335 25.8219C69.2335 30.8904 72.4584 34.7945 77.536 34.7945C82.6136 34.7945 85.9071 30.8904 85.9071 25.8219Z" fill="#032E47"></path>
                            <path
                                ...
                                fill="#032E47"
                            ></path>
                            <path d="M101.139 39.4521V17.1918H93.1113V12.0548H115V17.1918H107.04V39.4521H101.139Z" fill="#032E47"></path>
                            <path
                    ...
                    <div class="visible flex items-center">
                        <ul id="list" class="hidden p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16">
                            ...
                            <li class="flex flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center" @click="dropdownHandler(this)">
                                <a href="javascript:void(0)">
                                    <span class="ml-2 font-bold">Stats</span>
                                </a>
                            </li>
                            <li class="flex cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                                <a href="javascript:void(0)">
                                    <span class="ml-2 font-bold">Coins</span>
                                </a>
                            </li>
                            <li class="flex flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center" @click="dropdownHandler(this)">
                                <a href="javascript:void(0)">
        ...
        <div class="mx-auto container relative z-0 px-4 xl:px-0">
            <div class="flex flex-col-reverse md:flex-row">
                <div class="md:w-3/5 md:pt-24 pb-10 lg:py-32 xl:py-48">
                    <h1 class="text-3xl lg:text-6xl xl:text-8xl font-black text-gray-900 text-center md:text-left tracking-tighter f-f-i md:w-7/12 leading-tight text-heading-color">ONE WALLET TO RULE THEM ALL</h1>
                    <h2 class="md:w-8/12 py-4 text-center md:text-left md:py-8 text-gray-700 text-lg lg:text-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra eget donec nulla tellus bibendum.</h2>
                    <div class="w-full flex justify-center md:block">
                        <button class="hover:opacity-90 bg-indigo-700 py-3 px-10 lg:py-7 lg:px-20 rounded-full text-white text-sm md:text-lg f-f-p">Learn More</button>
                    </div>
                </div>
                <div class="w-1/2 sm:w-2/5 h-64 md:h-auto m-auto flex items-center overflow-hidden">
                    ...
                    <img class="md:absolute md:w-1/2 md:-ml-28" src="https://cdn.tuk.dev/assets/components/111220/Hero4/Device - Macbook Pro.png" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<script>
export default {
    name: "LeftAlignedWithCtaAndPlaceholder",
    mounted() {
        // slider js starts
