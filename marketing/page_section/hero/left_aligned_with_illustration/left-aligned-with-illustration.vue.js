<template>
    <div class="mx-auto container relative px-6 xl:px-0">
        <nav>
            <div class="lg:flex justify-between w-full py-12 hidden">
                ...
                <div class="lg:w-2/3 xl:w-1/2">
                    <ul class="font-normal text-lg flex justify-between items-center text-gray-700">
        ...
        <nav class="lg:hidden py-4">
            <div class="flex py-2 justify-between items-center">
                ...
                <div class="visible flex items-center">
                    <ul id="list" class="hidden py-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-20 md:px-4 md:mt-20 z-20">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 items-center pb-40">
            <div class="xl:mt-8">
                <div class="text-3xl lg:text-6xl xl:text-8xl text-gray-800 tracking-1px font-extrabold">
                    <h1 class="mt-2 lg:mt-0">Trustworthy</h1>
                    <h1 class="mt-2 lg:mt-0 text-indigo-700">Insurance</h1>
                    <h1 class="mt-2 lg:mt-0">Providers</h1>
                </div>
                <h2 class="text-lg lg:text-2xl tracking-wide leading-9 lg:w-10/12 mt-2 lg:mt-6 text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque suspendisse est mi</h2>
                <button class="hover:opacity-90 flex items-center relative focus:outline-none justify-center mt-5 lg:mt-10 text-lg lg:text-2xl font-medium text-white p-4 lg:p-8 bg-indigo-700 rounded-3xl">
                    Get a quote
                    <svg class="ml-8" xmlns="http://www.w3.org/2000/svg" width="26" height="17" viewBox="0 0 26 17" fill="none">
                        <path d="M1.33333 8.6665H24.6667" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M18 15.3332L24.6667 8.6665" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M18 2L24.6667 8.66667" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </button>
            </div>
            <div class="w-full custom-height bg-indigo-100 mt-8 lg:mt-0 rounded-3xl relative">
...
<script>
export default {
    name: "LeftAlignedWithIllustration",
    mounted() {
