                    ...
                    <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(1).png" alt="oliver" className="w-full" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            ...
                                            <div className="cursor-pointer">
                                                <svg className="ml-9" xmlns="http://www.w3.org/2000/svg" width={35} height={28} viewBox="0 0 35 28" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">Oliver Queen</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    ...
                                    <h5 className="text-gray-800 text-lg mt-2 font-medium">Founder, CEO</h5>
                                </div>
                            </div>
                        </div>
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(2).png" className="w-full" alt="Thea" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">Thea Queen</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    ...
                                    <h5 className="text-gray-800 text-lg mt-2 font-medium tracking-wider">Senior Architect</h5>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(3).png" className="w-full" alt="John" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">John Diggle</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke=" #4338CA" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(4).png" className="w-full" alt="Dinah" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">Dinah Lance</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke=" #4338CA" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(5).png" className="w-full" alt="sarah" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">Sarah Lance</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke=" #4338CA" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="https://cdn.tuk.dev/assets/templates/radian/team(6).png" className="w-full" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                                ...
                                <h4 className="text-2xl text-gray-800 font-semibold mt-2">Helena Rosa</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke=" #4338CA" strokeWidth={3} />
                                    </svg>
