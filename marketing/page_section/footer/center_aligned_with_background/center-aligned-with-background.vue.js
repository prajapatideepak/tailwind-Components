<template>
    <div class="bg-black py-16 flex flex-col items-center justify-center f-f-l">
        <div class="w-44">
        ...
        <div>
            <ul class="flex">
                <a href="javascript:void(0)">
                    <li class="lg:text-lg text-sm text-sm leading-5 lg:mr-10 mr-2 text-white flex flex-col items-end justify-end font-normal cursor-pointer hover:text-indigo-600">Home</li>
                </a>
                <a href="javascript:void(0)">
                    <li class="lg:text-lg text-sm text-sm leading-5 lg:mr-10 mr-2 text-white relative font-normal cursor-pointer hover:text-indigo-600">Menu</li>
                </a>
                <a href="javascript:void(0)">
                    <li class="lg:text-lg text-sm text-sm leading-5 lg:mr-10 mr-2 text-white flex flex-col items-end justify-end font-normal cursor-pointer hover:text-indigo-600">About</li>
                </a>
                <a href="javascript:void(0)">
                    <li class="lg:text-lg text-sm text-sm leading-5 lg:mr-10 mr-2 text-white flex flex-col items-end justify-end font-normal cursor-pointer hover:text-indigo-600">Contact</li>
                </a>
                <a href="javascript:void(0)">
                    <li class="lg:text-lg text-sm text-sm leading-5 text-white flex flex-col items-end justify-end font-normal cursor-pointer hover:text-indigo-600">Reservation</li>
                </a>
            </ul>
        </div>
