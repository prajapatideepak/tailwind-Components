        ...
        <div class="container sm:mx-auto">
            <div class="block xl:flex justify-between xl:items-center lg:items-center md:flex">
                <div class="w-11/12 xl:w-4/12 mx-auto xl:mx-0 md:w-5/12">
                    <h1 class="text-gray-800 text-3xl font-extrabold mb-3 pt-12 xl:pt-0">Sign Up for Product Updates</h1>
                    <p class="text-lg text-gray-600 mb-6">Sign Up for our weekly newsletter to get the latest news updates and amazing offers delivered directly in your inbox.</p>
                    <div class="flex w-full flex-wrap">
                        <div class="w-full">
                            <div class="flex flex-col mb-3">
                                <label class="text-base font-bold text-gray-800 mb-2" for="email">Email</label>
                                <input type="email" id="email" placeholder="johnstark97@gmail.com" class="focus:outline-none focus:border-indigo-700 border-gray-300 border rounded-sm py-2 outline-none pl-2 pr-2" />
                            </div>
                            <button type="submit" class="focus:outline-none bg-indigo-700 hover:bg-indigo-600 text-white text-base w-full py-3 px-6 rounded">Subscribe to Newsletter</button>
                        </div>
                    </div>
                </div>
                <div class="w-11/12 xl:w-5/12 mx-auto xl:mx-0 mt-8 xl:mt-0 flex justify-end md:w-5/12 bg-indigo-100 relative py-20">
                    <div class="h-4/5 w-4/5">
                        <img src="https://cdn.tuk.dev/assets/photo-1496430689199-7d6a8ebd3a2f.jfif" alt="" class="h-full w-full overflow-hidden object-cover relative z-10 xl:-ml-56 lg:-ml-32 sm:-ml-20 -ml-12 md:-ml-20 rounded" />
                    </div>
