    ...
    <div class="md:flex items-center justify-between">
      <div class="xl:w-5/12 md:w-1/2 xl:pr-16 md:pr-8">
        ...
        <p role="contentinfo" class="mt-4 text-base leading-6 text-gray-600">
          There are currently 26 letters in the English alphabet, but there was
          once a 27th letter. In fact, it still exists on computer keyboards.
          The 27th letter was "Et" and referred to as an "ampersand" or more
          commonly.
        </p>
        <button
          role="button"
    ...
    >
      <div>
        ...
        <p class="sm:w-72 w-full text-base mt-5 leading-6 text-gray-600">
          A phrase is a short selection of words which when put together create
          a concept.
        </p>
      </div>
      <div>
