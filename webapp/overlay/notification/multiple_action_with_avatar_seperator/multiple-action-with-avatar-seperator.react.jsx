...
const Index = () => {
    ...
    return (
        <div>
            <div role="alert" className={flag ? "xl:w-5/12 mx-auto sm:mx-0 sm:w-6/12 md:w-6/12 justify-between w-10/12 bg-white shadow-lg rounded flex absolute left-0 sm:left-auto right-0 dark:bg-gray-800 sm:top-0 sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 transition duration-150 ease-in-out translate-show" : "translate-hide"}>
                <div>
                    ...
                    <div className="flex flex-col justify-center border-l items-center border-gray-300 dark:border-gray-700 w-1/3 sm:w-1/6">
                        <div className="pt-2 pb-2 border-b border-gray-300 dark:border-gray-700 w-full flex justify-center">
                            <span className="text-sm text-blue-500 font-bold cursor-pointer">Reply</span>
                        </div>
                        <div className="pt-2 pb-2 flex justify-center w-full cursor-pointer" onclick="{() => setFlag(false)">
                            <span className="text-sm text-gray-600 dark:text-gray-400 cursor-pointer">Dismiss</span>
                        </div>
                    </div>
                </div>
            </div>
