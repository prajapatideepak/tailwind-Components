    ...
    <div class="bg-gray-200 dark:bg-gray-900 h-full">
        <div role="alert" class="xl:w-5/12 mx-auto sm:mx-0 sm:w-6/12 md:w-6/12 justify-between w-10/12 bg-white dark:bg-gray-800 shadow-lg rounded flex absolute left-0 sm:left-auto right-0 sm:top-0 sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 transition duration-150 ease-in-out" id="notification">
            <div class="flex items-center">
                <div class="px-2 sm:px-4 flex items-center justify-center">
                ...
                <div class="flex flex-col justify-center w-4/6 py-4">
            ...
            <div class="flex flex-col justify-center border-l items-center border-gray-300 dark:border-gray-700 px-4">
                <div class="pt-2 pb-2 w-full flex justify-center">
                    <span class="text-sm text-blue-500 font-bold cursor-pointer" @click="closeModal()">Reply</span>
                </div>
            </div>
        </div>
    </div>
