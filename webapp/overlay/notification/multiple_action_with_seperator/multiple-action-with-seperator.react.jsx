...
const Index = () => {
    ...
    return (
        <div>
            <div role="alert" className={flag ? "xl:w-5/12 mx-auto sm:mx-0 sm:w-6/12 md:w-3/5 justify-between w-11/12 bg-white shadow-lg rounded flex sm:flex-row flex-col absolute left-0 sm:left-auto dark:bg-gray-800 right-0 sm:top-0 sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 transition duration-150 ease-in-out translate-show" : "translate-hide"}>
                <div>
                    ...
                    <div className="flex flex-col justify-center xl:-ml-4 sm:pl-4 pl-4 xl:pl-1 sm:w-3/5 pt-4 sm:pb-4 pb-2">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 font-normal">Your booking has been confirmed. Check your email for details.</p>
                    </div>
                    <div className="flex sm:flex-col sm:justify-center sm:border-l items-center border-gray-300 dark:border-gray-700 sm:w-1/6 pl-4 xl:pl-0 sm:pl-0 md:pl-0 lg:pl-0">
                        <div className="sm:pt-4 pb-4 pb- sm:border-b border-gray-300 dark:border-gray-700 sm:w-full flex sm:justify-center">
                            <span className="sm:text-sm text-xs text-green-400 font-bold mr-4 cursor-pointer">View</span>
                        </div>
                        <div className="sm:pt-4 pb-4 flex sm:justify-center cursor-pointer w-full" onClick={() => setFlag(false)}>
