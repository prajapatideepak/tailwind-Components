...
const Index = () => {
    ...
    return (
        <div role="alert" classname={flag ? "sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 xl:w-5 mx-auto absolute left-0 sm:left-auto right-0 sm:top-0 sm:w-6 md:w-3 w-11 bg-white shadow-lg rounded flex sm:flex-row flex-col pr-4 transition duration-150 ease-in-out translate-show dark:bg-gray-800" : "translate-hide"} id="notification">
            <div className="relative mx-auto flex justify-center sm:justify-end pt-16 sm:pt-6 pb-6 sm:pb-16 h-64 overflow-x-hidden">
                ...
                <div role="alert" className="sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 xl:w-5/12 mx-auto absolute left-0 sm:left-auto right-0 sm:top-0 sm:w-6/12 md:w-3/5 w-11/12 bg-white shadow-lg rounded flex sm:flex-row flex-col pr-4 dark:bg-gray-800 transition duration-150 ease-in-out" id="notification">
                    ...
                    <div className="flex flex-col justify-center pl-4 sm:w-9/12 py-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 pb-2 font-normal">Congratulations. Your file has been downloaded successfully.</p>
                        <div className="flex">
                            <span className="text-sm text-green-400 font-bold mr-2 cursor-pointer">View </span>
                            <span className="text-sm pl-2 text-gray-600 dark:text-gray-400 cursor-pointer" onClick={() => setFlag(!flag)}>
                                Dismiss
                            </span>
                        </div>
                    </div>
