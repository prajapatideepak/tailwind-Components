        ...
        <div class="py-12 dark:bg-black bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
            <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                <div class="relative md:w-80 rounded shadow-lg p-6 dark:bg-gray-800 bg-white">
                    <h1 class="dark:text-gray-100 text-gray-800 font-bold text-lg">Privacy Notice</h1>
                    <p class="pt-6 text-xs font-semibold text-indigo-700">IMPORTANT</p>
                    <p class="py-4 text-base font-medium dark:text-gray-100 text-gray-800">Your backups may have personal data*</p>
                    <p class="text-sm font-medium dark:text-gray-100 text-gray-600 pb-4">*This data is viewable by everyone</p>
                    <p class="text-xs leading-3 dark:text-gray-100 text-gray-400">*This data is viewable by everyone</p>
                    <div class="sm:flex items-center justify-between pt-6">
                        <button class="py-3.5 px-10 dark:text-gray-100 text-gray-600 focus:outline-none hover:opacity-90 text-sm font-semibold border border-gray-600 rounded" @click="modalHandler()">Dismiss</button>
                        <button class="py-3.5 px-5 sm:mt-0 mt-4 text-white focus:outline-none hover:opacity-90 rounded border text-sm font-semibold border-indigo-700 bg-indigo-700">Sounds Good</button>
                    </div>
