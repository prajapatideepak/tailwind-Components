            ...
            <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                <div class="relative py-8 px-8 md:px-16 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
                    <div class="w-full flex justify-center text-gray-600 dark:text-gray-400 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-archive" width="56" height="56" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <h1 class="text-center text-gray-800 dark:text-gray-100 font-lg font-bold tracking-normal leading-tight mb-4">Add Project to Archive</h1>
                    <p class="mb-3 text-sm text-gray-600 dark:text-gray-400 text-center font-normal">Are you sure you want to archive this project? Note that by clicking the archive project, this project will be disable across all Unity services and the data, files and information associated with it may become irrecoverable.</p>
                    <p class="mb-5 text-sm text-gray-600 dark:text-gray-400 text-center font-normal">Type Archive Project to confirm this action. For more details click here</p>
                    <div class="flex items-center justify-center w-full">
                        <button class="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Archive</button>
