    ...
    return (
        <div className="min-h-screen bg-gray-200">
            <div className="flex items-center justify-center py-8 px-4">
                <div className="relative w-80 rounded shadow-lg pt-8 pb-6 px-6 dark:bg-gray-800 bg-white">
                    <div className="flex flex-col items-center justify-center">
                        <p className="text-lg font-bold leading-none text-gray-800 dark:text-gray-100">Do you like our Work?</p>
                        <p className="mt-3 mb-6 text-sm leading-tight text-center text-gray-500 dark:text-gray-400">We work really hard to deliver you the best paper products available in Scranton, we would love to hear what you think about us!</p>
                        ...
                        <button className="px-14 py-3 bg-indigo-700 dark:bg-indigo-600 hover:bg-opacity-80 focus:outline-none mt-8 rounded text-xs font-semibold leading-3 text-gray-100">Submit</button>
                    </div>
