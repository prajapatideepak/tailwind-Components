<template>
  <body style="min-height: 850px" class="bg-gray-700">
    <div class="w-full h-full flex justify-center py-12" id="button">
      <button
        role="button"
    ...
    <div class="bg-gray-700 absolute w-full h-full py-8 top-0" ref="modal" id="modal">
              ...
              <div class="sm:flex justify-between">
                <div>
                  ...
                  <div class="mt-2">
                    ...
                    <p
                      ...
                      "
                    >
                      JOHN SMITH<br />4304 Liberty Avenue<br />92680 Tustin,
                      CA<br />VAT no.: 12345678
                    </p>
                  </div>
                  <div class="mt-3">
                    <div class="flex space-x-1 items-center text-xs leading-3">
                      <p
                        ...
                        class="focus:outline-none text-blue-500"
                      >
                        @
                      </p>
                    ...
                    <div
                      class="flex space-x-1 items-center text-xs leading-3 mt-2"
                    >
                      <p
                        tabindex="0"
                        aria-label="mobile number icon"
                        class="focus:outline-none text-blue-500"
                      >
                        m
                      </p>
                ...
                >
                  ...
                  <p
                    ...
                    "
                  >
                    XYZ Company <br /><span class="text-gray-600"
                      >1331 Hart Ridge Road <br />48436 Gaines, MI <br />TAX ID:
                      987654321</span
                    >
                  </p>
                  <div class="mt-3">
                  ...
                  <div class="mt-6 text-xs leading-3 sm:text-right">
                    <p
                      tabindex="0"
                      class="focus:outline-none text-gray-800 uppercase"
                    >
                      invoice no.
                    </p>
                    <p
                      tabindex="0"
                      class="focus:outline-none text-gray-600 mt-1"
                    >
                      #IDO-2202-2
                    </p>
                    <div class="mt-3">
            ...
            <div class="pt-3.5 pb-9 px-10">
              <div class="w-full overflow-x-auto">
                <table class="w-full">
                  ...
                  >
                    <tr>
                      <th tabindex="0" class="focus:outline-none pb-2">
                        Items
                      </th>
                      <th tabindex="0" class="focus:outline-none pb-2">
                        Quantity
                      ...
                      <th
                        tabindex="0"
                        class="focus:outline-none pb-2 text-right"
                      >
                        Amount
                      </th>
                    </tr>
                  ...
                  <tbody>
                    <tr
                      ...
                      "
                    >
                      <td tabindex="0" class="focus:outline-none py-4 w-1/2">
                        Natural Herbs
                      </td>
                      <td tabindex="0" class="focus:outline-none py-4">
                        14 grams
                      </td>
                      <td tabindex="0" class="focus:outline-none py-4">$15</td>
                      <td
                        tabindex="0"
                        class="focus:outline-none py-4 text-right"
                      >
                        $28
                      </td>
                    </tr>
                    ...
                    <tr class="text-xs leading-3 text-gray-800 text-left">
                      ...
                      <td
                        tabindex="0"
                        class="focus:outline-none py-4 border-b border-gray-200"
                      >
                        Sub total
                      </td>
                      <td
                        tabindex="0"
                        class="focus:outline-none border-b border-gray-200 py-4"
                      ></td>
                      <td
                        tabindex="0"
                        class="
                    ...
                    <tr class="text-xs leading-3 text-gray-800 text-left">
                      ...
                      <td
                        tabindex="0"
                        class="focus:outline-none py-4 font-bold"
                      >
                        TOTAL
                      </td>
                      <td class="py-4"></td>
              ...
              <div class="mt-9">
                <p
                  tabindex="0"
                  class="focus:outline-none text-xs leading-4 text-gray-600"
                >
                  All amounts are in dollars. Please make the payment within 15
                  days from the issue of date of this invoice.
                </p>
