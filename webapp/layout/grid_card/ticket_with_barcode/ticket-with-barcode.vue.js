        ...
        <div class="cursor-pointer rounded-md shadow-lg bg-white dark:bg-gray-800 relative">
            <div class="py-5">
                <div class="px-6">
                    ...
                    <p class="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">New Year Costume Party</p>
                </div>
                <div class="mt-5 px-6">
                    <p class="text-xs text-gray-400">Day</p>
                    <p class="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">Tuesday, 9:00pm - 11:00pm</p>
                </div>
                <div class="mt-5 px-6">
                    <p class="text-xs text-gray-400">Date</p>
                    <p class="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">14th September 2020</p>
                </div>
                <div class="mt-5 px-6 flex items-center w-full">
                    <div>
                        <p class="text-xs text-gray-400">Tickets Sold</p>
                        <p class="text-sm leading-none text-justify text-gray-800 dark:text-gray-100 mt-1">857</p>
                    </div>
                    <div class="ml-14">
                ...
                <div class="mt-5 px-6 flex items-center text-gray-700 dark:text-gray-400">
                    ...
                    <p class="ml-2 text-xs leading-3 text-gray-600 dark:text-gray-400">Veevents.com/cosutmeparty</p>
                    <p></p>
                    <svg class="ml-3.5 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <rect x="5.33331" y="5.33301" width="8" height="8" rx="1.33333" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></rect>
                        <path d="M10.6667 5.33366V4.00033C10.6667 3.26395 10.0697 2.66699 9.33335 2.66699H4.00002C3.26364 2.66699 2.66669 3.26395 2.66669 4.00033V9.33366C2.66669 10.07 3.26364 10.667 4.00002 10.667H5.33335" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
                ...
                <div class="mt-4 px-6 flex flex-col w-full justify-center items-center">
                    ...
                    <p class="text-sm font-bold leading-none text-gray-700 dark:text-gray-400 mt-2">253704938890287467</p>
                </div>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            ticket: {
                ...
                timing: "Tuesday, 9:00pm - 11:00pm",
                date: "14th September 2020",
                sold: "857",
                revenue: "7698",
                link: "Veevents.com/cosutmeparty",
                isbn: "253704938890287467",
            },
        };
    },
};
