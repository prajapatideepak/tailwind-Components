                ...
                <div className="md:w-96 w-80 bg-white dark:bg-gray-800 rounded py-4 px-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <p className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-100 pr-3">Visitors</p>
                            <svg className="text-green-700 dark:text-green-400" xmlns="http://www.w3.org/2000/svg" width={53} height={20} viewBox="0 0 53 20" fill="none">
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center pr-4">
                                ...
                                <p className="text-xs font-semibold leading-3 dark:text-gray-100 text-gray-800 pl-1">new</p>
                            </div>
                            <div className="flex items-center">
                                <div className="w-3 h-3 bg-gradient-to-tl from-yellow-300 to-red-400 rounded-full" />
                                <p className="text-xs pl-1 font-semibold leading-3 dark:text-gray-100 text-gray-800">returning</p>
                            </div>
                        </div>
                    </div>
