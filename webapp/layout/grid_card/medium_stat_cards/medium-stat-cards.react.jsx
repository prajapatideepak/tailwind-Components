    ...
    return (
        <>
            ...
            <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                <div className="bg-white dark:bg-gray-800 rounded pt-5 pl-6 pr-12 pb-4 flex items-start shadow">
                    ...
                    <div className="pl-3 mt-1">
                        <h3 className="mb-3 leading-4 text-gray-600 dark:text-gray-400 text-base">Total Subscribers</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded pt-5 pl-6 pr-10 pb-4 flex items-start shadow">
                    <div className="text-gray-700 dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-dashboard" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx={12} cy={13} r={2} />
                    ...
                    <div className="pl-3 mt-1">
                        <h3 className="mb-3 leading-4 text-gray-600 dark:text-gray-400 text-base">Average Click Rate</h3>
                        <div className="flex items-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded pt-5 pl-6 pr-12 pb-4 flex items-start shadow">
                    ...
                    <div className="pl-3 mt-1">
                        <h3 className="mb-3 leading-4 text-gray-600 dark:text-gray-400 text-base">Total Sales</h3>
                        <div className="flex items-center">
                            <h2 className="text-gray-800 dark:text-gray-100 text-2xl leading-normal font-bold">2,330</h2>
                            ...
                            <p className="text-red-400 text-xs tracking-wide font-bold leading-normal pl-1">3.5%</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded pt-5 pl-6 pr-12 pb-4 flex items-start shadow">
                    ...
                    <div className="pl-3 mt-1">
                        <h3 className="mb-3 leading-4 text-gray-600 dark:text-gray-400 text-base">Profit Earned</h3>
                        <div className="flex items-center">
                            <h2 className="text-gray-800 dark:text-gray-100 text-2xl leading-normal font-bold">2,330</h2>
                            <div className="ml-3 text-green-400">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-trending-up" width={24} height={24} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
