<template>
  <body>
    <div class="flex items-center justify-center py-6 sm:px-6 px-4 w-full">
      <div class="max-w-6xl w-full bg-white shadow">
        <div class="border-b border-gray-200 p-4">
          <div class="flex items-center justify-between">
            <h1 class="text-sm font-semibold leading-none text-indigo-700">
              Front End Developer
            </h1>
            <div class="p-1 bg-green-50">
              <p class="text-sm font-medium leading-none text-green-700">
                Full-time
              </p>
            </div>
          </div>
          <div class="mt-3 sm:flex items-center justify-between">
            <div class="sm:flex items-center">
              <div class="flex items-center">
                <div role="img" aria-label="Engineering">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M10.625 9C8.99781 9 5.75 10.005 5.75 12V13.5H15.5V12C15.5 10.005 12.2522 9 10.625 9Z"
                      fill="#4B5563"
                    />
                    <path
              ...
              <div class="flex items-center sm:mt-0 mt-4 sm:ml-6">
                <div role="img" aria-label="Engineering">
                  <svg
                    width="10"
                    height="14"
            ...
            <p class="text-sm leading-none text-gray-600 sm:mt-0 mt-4">
              Closing on 23 July,2021
            </p>
          </div>
        </div>
        <div class="border-b border-gray-200 p-4">
          ...
          <div class="mt-3 sm:flex items-center justify-between">
            <div class="sm:flex items-center">
              <div class="flex items-center">
                ...
                <p class="text-sm leading-none text-gray-600 ml-2">Arts</p>
              </div>
              <div class="flex items-center sm:mt-0 mt-4 sm:ml-6">
                <div role="img" aria-label="Engineering">
                  <svg
