                    ...
                    <table className="w-full">
                        ...
                        <tbody className="bg-white dark:bg-gray-800">
                                    ...
                                    <div className="flex items-center">
                                        <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={21} height={22} viewBox="0 0 21 22" fill="none">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M15.4167 10.0688H20C20 4.54593 15.5229 0.0688477 10 0.0688477C12.9917 0.0688477 15.4167 4.54593 15.4167 10.0688Z" fill="#F96E6F" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M10 0.0688477C4.47708 0.0688477 0 4.54593 0 10.0688H4.58333C4.58333 4.54593 7.00833 0.0688477 10 0.0688477Z" fill="#F96E6F" />
                            ...
                            <tr className="border-b border-gray-200 dark:border-gray-900">
                                ...
                                <td className="py-4 sm:pl-6 pl-4">
                                    <p className="text-sm font-semibold leading-none text-gray-800 dark:text-gray-100">162</p>
                                    <p className="text-xs leading-3 text-gray-500 dark:text-gray-400 pt-2">in 24 hours</p>
                                </td>
                                <td className="py-4 sm:pl-6 pl-4">
                            ...
                            <tr className="border-b border-gray-200 dark:border-gray-900">
                                ...
                                <td className="py-4 sm:pl-6 pl-4">
                                    <p className="text-sm font-semibold leading-none text-gray-800 dark:text-gray-100">214</p>
                                    <p className="text-xs leading-3 text-gray-500 dark:text-gray-400 pt-2">in 24 hours</p>
                                </td>
                                <td className="py-4 sm:pl-6 pl-4">
                                    ...
                                    <div className="flex items-center">
                                        <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={20} viewBox="0 0 16 20" fill="none">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M16 17.1C16 18.1493 15.1045 19 14 19H2C0.8955 19 0 18.1493 0 17.1V1.9C0 0.850725 0.8955 0 2 0H14C15.1045 0 16 0.850725 16 1.9V17.1Z" fill="#82868B" />
                                                <g opacity="0.2">
                            ...
                            <tr className="border-b border-gray-200 dark:border-gray-900">
                                    ...
                                    <div className="flex items-center">
                                        <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 22 22" fill="none">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M10.6255 13.0985C9.85236 13.928 7.6009 19.7838 7.6009 19.7838C7.27047 20.4278 7.76488 20.8954 8.88937 20.2828L12.9297 17.9184C15.1066 16.6203 15.5275 16.2812 15.4987 13.6385L15.0937 10.5182C14.955 9.44926 14.2092 9.25307 13.436 10.0826L10.6255 13.0985Z" fill="#F96E6F" />
                                                <path fillRule="evenodd" clipRule="evenodd" d="M7.97038 11.0526C7.14084 11.9224 1.28504 14.4553 1.28504 14.4553C0.641029 14.8271 0.173482 14.2709 0.786038 13.0058L3.15043 8.46046C4.44858 6.01142 4.78764 5.53794 7.43033 5.57036L10.5507 6.02596C11.6196 6.18192 11.8158 7.021 10.9862 7.89083L7.97038 11.0526Z" fill="#F96E6F" />
                                                <g opacity="0.2">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M5.65234 12.6804C8.22537 9.82204 10.3871 10.6941 10.3871 10.6941C10.3871 10.6941 11.1726 13.0956 8.5991 15.9539C6.02557 18.8122 1.85924 20.8887 1.53469 20.5281C1.22029 20.1783 3.07881 15.5387 5.65234 12.6804Z" fill="#FFAF63" />
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M16.61 12.3619C12.6719 16.5782 6.6348 15.4245 6.6348 15.4245C6.6348 15.4245 5.55726 8.96137 9.49529 4.74455C13.4333 0.527738 19.3999 0.0796574 20.1835 0.918594C20.9433 1.73216 20.5485 8.14565 16.61 12.3619Z" fill="white" />
                                                <g opacity="0.2">
                                                ...
                                                <path fillRule="evenodd" clipRule="evenodd" d="M5.71244 16.9887C5.32759 17.4217 5.05213 17.8136 4.66729 17.3806C4.28244 16.9477 4.63082 16.6378 5.01567 16.2049L9.89353 9.14898C10.2784 8.71602 11.9479 8.32409 12.3327 8.75705C12.7176 9.19 12.3692 11.0682 11.9843 11.5011L5.71244 16.9887Z" fill="#F96E6F" />
                                                <g opacity="0.2">
                                        ...
                                        <div className="pl-5">
                                            <p className="text-sm font-semibold leading-none text-gray-800 dark:text-gray-100 pb-2">Kmart</p>
                                            <p className="text-xs leading-3 text-gray-500 dark:text-gray-400">meguc@ruj.io</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="py-4 sm:pl-6 pl-4">
                                    <p className="text-sm font-semibold leading-none text-gray-800 dark:text-gray-100">990</p>
                                    <p className="text-xs leading-3 text-gray-500 dark:text-gray-400 pt-2">in 24 hours</p>
                                </td>
                                <td className="py-4 sm:pl-6 pl-4">
                                    <p className="text-sm leading-none text-gray-800 dark:text-gray-100">$891.2</p>
