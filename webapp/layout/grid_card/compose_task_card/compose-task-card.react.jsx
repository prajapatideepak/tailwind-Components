                    ...
                    <div className="container flex flex-col w-full h-full justify-between">
                        <div>
                            <div className="flex w-full justify-between items-center">
                                <h2 className="text-4xl font-bold dark:text-gray-100 text-gray-900">Compose Task</h2>
                            ...
                            <div className="flex flex-col items-start md:flex-row w-full md:items-center py-1 bg-gray-100 dark:bg-gray-700 mt-12">
                                <div className="relative dark:bg-gray-700">
                                    <select className="focus:outline-none md:border-r dark:border-gray-800 border-gray-300 bg-transparent  appearance-none cursor-pointer text-sm py-3 pl-4 pr-12 text-gray-700 dark:text-gray-400">
                                        <option>Paragraph</option>
                                    </select>
                                    <div className="w-4 h-4 absolute m-auto text-gray-700 dark:text-gray-400 inset-0 mr-4 pointer-events-none cursor-pointer">
                            ...
                            <div className="mt-10 border-b border-gray-400">
                                <input className="w-full text-2xl bg-transparent font-bold pb-2 focus:outline-none placeholder-gray-400" placeholder="Fix Car Foundation" type="text" />
                            </div>
                            <div className="mt-12">
                        ...
                        <div className="mt-4 md:mt-0">
                            ...
                            <div className="md:flex justify-between w-full py-4 border-t border-gray-400">
                                ...
                                <div className="mt-4 md:mt-0">
                                    <button className="text-sm text-white focus:outline-none py-3 px-6 hover:bg-indigo-600 bg-indigo-700 rounded-md">Save Task</button>
                                </div>
                            </div>
                        </div>
                    </div>
