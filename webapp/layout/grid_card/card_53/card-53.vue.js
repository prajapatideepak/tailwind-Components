<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
        <div class="flex items-center justify-center w-full h-full py-8 px-4">
            <div class="w-full sm:max-w-2xl bg-white dark:bg-gray-800 pt-6 pb-10 rounded-lg">
                <p class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-100 px-8">Top Browsers</p>

                <div class="w-full mt-6 overflow-x-scroll sm:overflow-x-auto">
                    <table class="w-full">
                        <thead class="text-xs sm:text-base font-medium leading-none text-gray-500 dark:text-gray-400">
                            <tr class="border-b border-gray-200">
                                <td class="pb-4 pl-8">Browser</td>
                                <td class="pb-4 pl-4">Sessions</td>
                                <td class="pl-14 pb-4">Bounce&nbsp;Rate</td>
                                <td class="pl-14 pb-4">Transactions</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="text-xs sm:text-base leading-none text-gray-800 dark:text-gray-100">
                                <td class="pl-8 pt-6">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 border text-gray-500 dark:text-gray-400 dark:border-gray-400 border-gray-500 flex items-center justify-center rounded">
                                        ...
                                        <p class="ml-3">Chrome</p>
                                    </div>
                                </td>
                                <td class="pt-6 pl-4">5,894</td>
                                <td class="pt-6 pl-14">85.67%</td>
                                <td class="pt-6 pl-14">572</td>
                            </tr>
                            <tr class="text-xs sm:text-base leading-none text-gray-800 dark:text-gray-100">
                                <td class="pl-8 pt-6">
                                    <div class="flex items-center">
                                ...
                                <td class="pt-6 pl-4">4,296</td>
                                <td class="pt-6 pl-14">54.61%</td>
                                <td class="pt-6 pl-14">745</td>
                            </tr>
                            <tr class="text-xs sm:text-base leading-none text-gray-800 dark:text-gray-100">
                                <td class="pl-8 pt-6">
                                    <div class="flex items-center">
                                        ...
                                        <p class="ml-3">Safari</p>
                                    </div>
                                </td>
                                <td class="pt-6 pl-4">3.969</td>
                                <td class="pt-6 pl-14">53.02%</td>
                                <td class="pt-6 pl-14">653</td>
                            </tr>
                            <tr class="text-xs sm:text-base leading-none text-gray-800 dark:text-gray-100">
                                <td class="pl-8 pt-6">
                                    <div class="flex items-center">
                                        ...
                                        <p class="ml-3">Mozilla&nbsp;Firefox</p>
                                    </div>
                                </td>
                                <td class="pt-6 pl-4">1,321</td>
                                <td class="pt-6 pl-14">65.85%</td>
                                <td class="pt-6 pl-14">320</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
