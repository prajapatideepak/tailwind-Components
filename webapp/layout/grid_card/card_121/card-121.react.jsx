                ...
                <div className="w-64 p-4  rounded border hover:shadow-lg">
                    <div className="flex justify-center items-center flex-col ">
                        ...
                        <div className="flex justify-center items-center flex-col mt-3">
                            ...
                            <p className="text-sm font-medium leading-none text-gray-600 mt-1">Graphic Designer</p>
                        </div>
                    </div>
                    ...
                    <div className="h-16 mt-14">
                        <canvas height={56} tabIndex={0} className="focus:outline-none" aria-label="graph" role="img" id="myChart" />
                    </div>
                    <div className="w-56 h-9">
                        <button role="button" aria-label="message" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 hover:bg-gray-100 flex items-center justify-center flex-1 h-full py-3 px-20 bg-gray-50 border rounded border-gray-200">
