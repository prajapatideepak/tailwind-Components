    ...
    <div className="py-12 flex justify-center">
        <div className="cursor-pointer flex flex-col mt-4 md:mt-0 ">
            ...
            <div className="flex justify-between w-full px-4 py-5  bg-gray-100 dark:bg-gray-800 rounded-bl-sm rounded-br-sm">
                <p className="text-xl leading-tight tracking-tight text-gray-900 dark:text-gray-50 capitalize">Grid card</p>
                <p className="text-xl leading-tight tracking-tight text-gray-900 dark:text-gray-50">12</p>
            </div>
        </div>
    </div>
);
