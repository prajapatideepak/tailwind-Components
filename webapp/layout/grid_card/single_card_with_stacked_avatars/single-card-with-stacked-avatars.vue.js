<template>
    <div class="mx-auto container py-12 px-6 dark:bg-gray-900 flex justify-center items-center">
        <div class="max-w-xs">
            <div class="w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-3 py-5 px-4">
                <div class="mb-5 w-20 rounded border border-gray-400 py-1 pl-2 pr-3 flex items-center">
                    ...
                    <p class="text-xs text-gray-800 dark:text-gray-100">Family</p>
                </div>
                <h4 class="text-gray-800 dark:text-gray-100 font-semibold mb-4">Company website redesign</h4>
                <p class="mb-3 text-gray-600 dark:text-gray-400 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat ar ..</p>
                <div class="flex items-center justify-between text-gray-600 dark:text-gray-400">
                    <div class="mb-5 rounded-full border border-gray-400 py-1 pl-2 pr-3 flex items-center">
                        ...
                        <p class="ml-2 text-xs">7 Sept, 23:00</p>
                    </div>
                    <p class="text-xs text-red-500 font-semibold">Two days ago</p>
                </div>
