    ...
    return (
        <>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 shadow rounded mx-auto">
                <h4 className="text-gray-800 dark:text-gray-100 font-normal text-lg leading-4 tracking-normal mb-2">Invoice # 35RD87</h4>
                <p className="text-gray-600 dark:text-gray-400 text-xs leading-3 font-normal">Assigned to: Josh Rollins</p>
                <div className="mt-4 flex items-center">
                    ...
                    <p className="ml-1 text-sm text-gray-800 dark:text-gray-100 leading-3 tracking-normal font-normal">Specter Consultancy</p>
                </div>
                <div className="mt-1 flex items-center">
                    ...
                    <p className="ml-1 text-sm text-gray-800 dark:text-gray-100 leading-3 tracking-normal font-normal">2,354 USD</p>
                </div>
