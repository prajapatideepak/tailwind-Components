<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
        <div class="flex justify-center py-12 sm:px-6 px-4">
            <div class="sm:max-w-sm max-w-xs rounded shadow dark:bg-gray-800 bg-white">
                <!-- Please include this script in the head section of your webpage to make the chart work.-->
                <!-- <script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script> -->
                <div class="sm:px-6 py-6 px-2 flex items-center">
                    <p class="text-xl font-medium leading-5 md:pr-36 pr-24 text-gray-600 dark:text-gray-100">Goal Overview</p>
                    <span>
                ...
                <div class="sm:px-7 px-2 relative">
                    <canvas id="myChart" width="150"></canvas>
                    <div class="absolute inset-0 flex flex-col items-center justify-center mt-14">
                        <p class="text-5xl font-semibold leading-10 text-center text-gray-800 dark:text-gray-100">69%</p>
                        <p class="text-2xl font-semibold leading-normal text-center pt-2 text-gray-500 dark:text-gray-400">complete</p>
                    </div>
                </div>
                <div class="w-full border-t border-gray-300 dark:border-gray-900 mt-8">
                    <div class="flex items-center justify-center">
                        <div class="py-4 sm:pr-12 pr-4">
                            <p class="text-sm leading-none text-center text-gray-500 dark:text-gray-400">Completed</p>
                            <p class="text-xl font-semibold leading-5 py-3.5 text-center text-gray-800 dark:text-gray-100">786,617</p>
                        </div>
                        <div class="py-4 border-l border-gray-200 dark:border-gray-900">
                            <div class="sm:pl-12 pl-4">
                                <p class="text-sm leading-none text-center text-gray-500 dark:text-gray-400">In progress</p>
                                <p class="text-xl font-semibold leading-5 py-3.5 text-center text-gray-800 dark:text-gray-100">76,617</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    datasets: [
                        {
                            label: "# of Votes",
                            data: [86, 60],
                            backgroundColor: [green_blue_gradient, "#E2E8F0"],
