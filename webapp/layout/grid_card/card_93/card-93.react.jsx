            ...
            <div className="flex items-center justify-center py-8">
                <div className="sm:max-w-sm max-w-xs  rounded shadow dark:bg-gray-800 bg-white">
                    ...
                    <div className="sm:px-6 py-6 px-2 flex items-center">
                        <p className="text-xl font-medium leading-5 md:pr-36 pr-24 text-gray-600 dark:text-gray-100">Goal Overview</p>
                        <span>
                    ...
                    <div className="sm:px-7 px-2 relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center mt-14">
                            <p className="text-5xl font-semibold leading-10 text-center text-gray-800 dark:text-gray-100">69%</p>
                            <p className="text-2xl font-semibold leading-normal text-center pt-2 text-gray-500 dark:text-gray-400">complete</p>
                        </div>
                    </div>
                    <div className="w-full border-t border-gray-300 dark:border-gray-900 mt-8">
                        <div className="flex items-center justify-center">
                            <div className="py-4 sm:pr-12 pr-4">
                                <p className="text-sm leading-none text-center text-gray-500 dark:text-gray-400">Completed</p>
                                <p className="text-xl font-semibold leading-5 py-3.5 text-center text-gray-800 dark:text-gray-100">786,617</p>
                            </div>
                            <div className="py-4 border-l border-gray-200 dark:border-gray-900">
                                <div className="sm:pl-12 pl-4">
                                    <p className="text-sm leading-none text-center text-gray-500 dark:text-gray-400">In progress</p>
                                    <p className="text-xl font-semibold leading-5 py-3.5 text-center text-gray-800 dark:text-gray-100">76,617</p>
                                </div>
                            </div>
                        </div>
                    </div>
