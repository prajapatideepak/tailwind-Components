<template>
    <div class="max-w-sm p-6 rounded shadow bg-white dark:bg-gray-800">
        <div class="flex items-start justify-between">
            ...
            <svg class="mt-4 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 46 11" fill="none">
        ...
        <p class="text-lg font-bold leading-5 text-gray-800 dark:text-gray-100 mt-3">Product Designer</p>
        <p class="text-base leading-5 text-gray-500 dark:text-gray-400 mt-3">We are looking to hire a freelance UI/UX designer fluent in the use of Figma and invision studio.</p>
        <div>
            <div class="flex items-center mt-4">
                ...
                <div class="bg-gray-100 dark:bg-gray-800 rounded-full w-20 h-10 flex items-center justify-center ml-8">
        ...
        <div class="mt-6 flex items-center">
            <div class="flex items-center">
                <img class="w-6 h-6 rounded-full" src="https://i.ibb.co/bbWSx2p/1.png" alt="dp" />
                <img class="-ml-2 w-6 h-6 rounded-full" src="https://i.ibb.co/QY635bP/2.png" alt="dp" />
                <img class="-ml-2 w-6 h-6 rounded-full" src="https://i.ibb.co/F0y6TTT/3.png" alt="dp" />
                <div class="w-6 h-6 -ml-2 bg-white border-2 border-gray-200 dark:border-gray-100 dark:bg-gray-800 flex items-center justify-center rounded-full">
                    <p class="text-sm font-semibold leading-4 text-gray-500 dark:text-gray-100">+2</p>
                </div>
            </div>
            <p class="ml-2 text-xs leading-4 text-gray-500 dark:text-gray-400 sm:ml-5">5+ have applied</p>
        </div>
        <div class="flex items-center justify-between mt-6">
            <button class="flex items-center sm:px-9 px-4 py-3 hover:bg-indigo-600 bg-indigo-700 rounded">
                <p class="text-sm font-semibold leading-4 text-center text-white">Apply Now</p>
            </button>
            <button class="flex items-center sm:px-10 px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded ml-6 sm:ml-14">
                <p class="text-sm font-semibold leading-4 text-center text-indigo-700">Message</p>
            </button>
        </div>
    </div>
</template>
