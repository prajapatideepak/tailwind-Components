...
const index = (props) => {
    return (
        <>
            <div className="max-w-sm p-6 rounded shadow bg-white dark:bg-gray-800">
                <div className="flex items-start justify-between">
                    <div className="w-20 h-20 rounded-full flex items-center justify-center bg-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" width={50} height={31} viewBox="0 0 113 76" fill="none">
                            <path d="M55.8038 5.90554H62.7954V0H55.8038V5.90554Z" fill="#475293" />
                            <path d="M62.7954 5.90554H69.787V0H62.7954V5.90554Z" fill="#FF3565" />
                            <path d="M55.8038 11.8111H62.7954V5.90558H55.8038V11.8111Z" fill="#5C5C68" />
                            <path d="M62.7954 11.8111H69.787V5.90558H62.7954V11.8111Z" fill="#DCE7E6" />
                            <path d="M98.672 31.1567L113 11.8111H96.2655L86.1787 27.4542V0H72.2974V51.4384H86.1787V43.0321L88.8777 39.4078L95.2791 51.4384H112.323L98.672 31.1567Z" fill="#5C5C68" />
                            <path d="M55.9056 37.1715C55.8981 37.179 55.8896 37.1876 55.8831 37.1961C55.8242 40.2764 53.3191 42.759 50.2239 42.759C47.0923 42.759 44.554 40.2207 44.554 37.089V0H30.7648V38.3186C30.7648 47.556 39.275 51.432 45.7011 51.432C52.2567 51.432 54.0207 49.8994 55.9056 48.2254V51.4384H69.787V14.1898H55.9056V37.1715Z" fill="#D81767" />
                            <path d="M55.8039 37.8591C55.4258 40.6212 53.091 42.759 50.2239 42.759C47.0923 42.759 44.554 40.2207 44.554 37.089V0H30.7648V38.3186C30.7648 47.556 39.275 51.432 45.7011 51.432C52.1389 51.432 53.9564 49.9529 55.8039 48.3143V37.8591Z" fill="#5C5C68" />
                            <path d="M55.9055 51.4384H69.7869V49.9658H55.9055V51.4384Z" fill="#D81767" />
                            <path d="M55.8038 51.4384H69.7869V14.1898H55.8038V51.4384Z" fill="#FF3565" />
                            <path d="M0 0V12.8371H13.8042V51.4384H28.4931V12.8553H30.7647V13.5729H44.554V0H0Z" fill="#5C5C68" />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                    ...
                    <svg className="mt-4 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 46 11" fill="none">
                        <path fillRule="evenodd" clipRule="evenodd" d="M35.5 5.5C35.5 8.26 37.74 10.5 40.5 10.5C43.26 10.5 45.5 8.26 45.5 5.5C45.5 2.74 43.26 0.5 40.5 0.5C37.74 0.5 35.5 2.74 35.5 5.5ZM28 5.5C28 2.74 25.76 0.5 23 0.5C20.24 0.5 18 2.74 18 5.5C18 8.26 20.24 10.5 23 10.5C25.76 10.5 28 8.26 28 5.5ZM5.5 0.5C8.26 0.5 10.5 2.74 10.5 5.5C10.5 8.26 8.26 10.5 5.5 10.5C2.74 10.5 0.5 8.26 0.5 5.5C0.5 2.74 2.74 0.5 5.5 0.5Z" fill="#6B7280" />
                    </svg>
                </div>
                <p className="text-lg font-bold leading-5 text-gray-800 dark:text-gray-100 mt-3">Product Designer</p>
                <p className="text-base leading-5 text-gray-500 dark:text-gray-400 mt-3">We are looking to hire a freelance UI/UX designer fluent in the use of Figma and invision studio.</p>
                <div>
                    <div className="flex items-center mt-4">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-full w-20 h-10 flex items-center justify-center ml-8">
                ...
                <div className="mt-6 flex items-center">
                    <div className="flex items-center">
                        <img className="w-6 h-6 rounded-full" src="https://i.ibb.co/bbWSx2p/1.png" alt="dp" />
                        <img className="-ml-2 w-6 h-6 rounded-full" src="https://i.ibb.co/QY635bP/2.png" alt="dp" />
                        <img className="-ml-2 w-6 h-6 rounded-full" src="https://i.ibb.co/F0y6TTT/3.png" alt="dp" />
                        <div className="w-6 h-6 -ml-2 bg-white border-2 border-gray-200 dark:border-gray-100 dark:bg-gray-800 flex items-center justify-center rounded-full">
                            <p className="text-sm font-semibold leading-4 text-gray-500 dark:text-gray-100">+2</p>
                        </div>
                    </div>
                    <p className="ml-2 text-xs leading-4 text-gray-500 dark:text-gray-400 sm:ml-5">5+ have applied</p>
                </div>
                <div className="flex items-center justify-between mt-6">
                    <button className="flex items-center sm:px-9 px-4 py-3 hover:bg-indigo-600 bg-indigo-700 rounded">
                        <p className="text-sm font-semibold leading-4 text-center text-white">Apply Now</p>
                    </button>
                    <button className="flex items-center sm:px-10 px-6 py-3 bg-gray-100 hover:bg-gray-200 rounded ml-6 sm:ml-14">
                        <p className="text-sm font-semibold leading-4 text-center text-indigo-700">Message</p>
                    </button>
                </div>
            </div>
        </>
