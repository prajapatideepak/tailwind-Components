        ...
        <>
            <div className="flex items-center justify-center py-8 px-4">
                <div className="md:w-96 rounded shadow-lg p-5 bg-white dark:bg-gray-800 w-full">
                    <h1 className="text-lg font-bold leading-3 text-gray-800 dark:text-gray-100">Select Payment Options</h1>
                    <div className="pt-7">
                        <div className="flex items-start justify-between">
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-col pl-2">
                                    <p className="text-sm font-semibold  leading-3 text-gray-800 dark:text-gray-100">Ending with 7562</p>
                                    <p className="text-xs leading-3 pt-2 text-gray-600 dark:text-gray-400">CVV: 822 | Expiry: 07/2021</p>
                                </div>
                            </div>
                            <p className="text-sm font-semibold leading-3 text-right text-gray-800 dark:text-gray-100">$12,300</p>
                        </div>
                    </div>
                    <div className="pt-6">
                        <div className="flex items-start justify-between">
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-col pl-2">
                                    <p className="text-sm font-semibold  leading-3 text-gray-800 dark:text-gray-100">Ending with 1881</p>
                                    <p className="text-xs leading-3 text-gray-600 dark:text-gray-400 pt-2">CVV: 822 | Expiry: 07/2021</p>
                                </div>
                            </div>
                            <p className="text-sm font-semibold leading-3 text-right text-gray-800 dark:text-gray-100">$9,300</p>
                        </div>
                    </div>
                    <div className="pt-6">
                        <div className="flex items-start justify-between">
                            <div className="flex items-start">
                                ...
                                <div className="flex flex-col pl-2">
                                    <p className="text-sm font-semibold  leading-3 text-gray-800 dark:text-gray-100">Ending with 1929</p>
                                    <p className="text-xs leading-3 text-gray-600 dark:text-gray-400 pt-2">CVV: 822 | Expiry: 07/2021</p>
                                </div>
                            </div>
                            <p className="text-sm font-semibold leading-3 text-right text-gray-800 dark:text-gray-100">$99,300</p>
                        </div>
                    </div>
                </div>
            </div>
