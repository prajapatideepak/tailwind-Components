    ...
    return (
        <>
            <div className="flex items-center justify-center bg-gray-200 dark:bg-gray-900 py-12">
                <div>
                    <div className="rounded max-w-xl shadow p-6 relative bg-white dark:bg-gray-800">
                        <div className="sm:flex items-start">
                            <div>
                                <div className="w-20 h-20 rounded-full flex items-center justify-center bg-gray-100">
                                    <svg className xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 113 76" fill="none">
                            ...
                            <div className="ml-4">
                                <div className="py-2 px-4 sm:top-8 top-12 absolute right-0 bg-green-100 flex items-center justify-center rounded-tl-3xl rounded-bl-3xl">
                                    <p className="text-xs font-semibold text-center text-green-700">SPONSORED</p>
                                </div>
                                <div className="sm:pt-0 pt-4">
                                    <p className="text-xl font-semibold leading-5 pt-1 text-gray-800 dark:text-gray-100">Product Designer</p>
                                    <p className="text-sm leading-4 pt-2 text-gray-500 dark:text-gray-400">
                                        <span className="text-indigo-700 font-semibold">Invision App</span>, Singapore
                                    </p>
                                </div>
                                <div className="mt-2">
                                    <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">We are looking to hire a freelance UI/UX designer fluent in the use of Figma with at least 2 years of experience in delivering top quality web application and mobile application designs.</p>
                                    <div className="sm:flex items-center mt-4">
                                        <div className="flex items-center">
                                            ...
                                            <p className="text-sm leading-4 text-gray-500 ml-2 dark:text-gray-400">Full Time</p>
                                        </div>
                                        <div className="flex items-center sm:ml-14 sm:mt-0 mt-4">
                                            ...
                                            <p className="text-sm leading-4 text-gray-500 ml-2 dark:text-gray-400">2 years experience</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
