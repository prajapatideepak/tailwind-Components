<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
        <div class="flex justify-center py-12 sm:px-6 px-4">
            <div>
                <div class="rounded max-w-xl shadow p-6 relative bg-white dark:bg-gray-800">
                    <div class="sm:flex items-start">
                        <div>
                            <div class="w-20 h-20 rounded-full flex items-center justify-center bg-gray-100">
                                <svg class="" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 113 76" fill="none">
                        ...
                        <div class="ml-4">
                            <div class="py-2 px-4 sm:top-8 top-12 absolute right-0 bg-green-100 flex items-center justify-center rounded-tl-3xl rounded-bl-3xl">
                                <p class="text-xs font-semibold text-center text-green-700">SPONSORED</p>
                            </div>
                            <div class="sm:pt-0 pt-4">
                                <p class="text-xl font-semibold leading-5 pt-1 text-gray-800 dark:text-gray-100">Product Designer</p>
                                <p class="text-sm leading-4 pt-2 text-gray-500 dark:text-gray-400"><span class="text-indigo-700 font-semibold">Invision App</span>, Singapore</p>
                            </div>

                            <div class="mt-2">
                                <p class="text-xs leading-5 text-gray-500 dark:text-gray-400">We are looking to hire a freelance UI/UX designer fluent in the use of Figma with at least 2 years of experience in delivering top quality web application and mobile application designs.</p>
                                <div class="sm:flex items-center mt-4">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 36 36" fill="none">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M25.2 19.8H18C17.0064 19.8 16.2 18.9954 16.2 18V10.8C16.2 9.8046 17.0064 9 18 9C18.9936 9 19.8 9.8046 19.8 10.8V16.2H25.2C26.1954 16.2 27 17.0046 27 18C27 18.9954 26.1954 19.8 25.2 19.8ZM18 0C8.0748 0 0 8.0748 0 18C0 27.9252 8.0748 36 18 36C27.9252 36 36 27.9252 36 18C36 8.0748 27.9252 0 18 0Z" fill="#6B7280" />
                                        </svg>
                                        <p class="text-sm leading-4 text-gray-500 ml-2 dark:text-gray-400">Full Time</p>
                                    </div>
                                    <div class="flex items-center sm:ml-14 sm:mt-0 mt-4">
                                        ...
                                        <p class="text-sm leading-4 text-gray-500 ml-2 dark:text-gray-400">2 years experience</p>
                                    </div>
                                </div>
                            </div>
                        </div>
