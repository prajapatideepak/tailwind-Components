        ...
        <div className="w-full h-full flex items-center justify-center py-8 md:px-0 px-4 dark:bg-gray-900">
            <div className="bg-white dark:bg-gray-800 pb-6 shadow-xl max-w-sm">
                ...
                <div className="mt-4 pl-4">
                    <p className="w-2/4 text-base font-bold leading-normal text-gray-800 dark:text-gray-100">New Years Costume Party</p>
                </div>
                <div className="mt-4 flex items-center pl-4 text-gray-600 dark:text-gray-100">
                    ...
                    <p className="text-sm leading-none text-gray-700 dark:text-gray-100 ml-2">14th September 2020</p>
                </div>
                <div className="mt-4 pl-4 flex items-center text-gray-600 dark:text-gray-100">
                    ...
                    <p className="text-sm leading-none text-gray-700 dark:text-gray-100 ml-2">Tuesday, 9:00 pm - 11:00 pm</p>
                </div>
                <div className="mt-4 pl-4">
                    <p className="text-xs leading-3 text-gray-700 dark:text-gray-100">Attended by</p>
                </div>
                <div className="mt-3 pl-4 flex w-full items-center justify-between">
                    <div className="flex items-center relative">
                        ...
                        <div className="w-6 h-6 rounded-full flex justify-center border-2 border-white bg-indigo-400 items-center -ml-2">
                    ...
                    <div className="py-2 px-5 flex justify-center items-center bg-gray-800">
                        <p className="text-sm font-bold leading-none text-white dark:text-gray-100">$ 45</p>
                    </div>
                </div>
                <div className="mt-5 pl-4">
                    <div className="flex items-center">
                        ...
                        <div className="pl-2 border-l-2 border-gray-100 dark:border-gray-200">
                            <p className="text-xs leading-3 text-indigo-500">86/90 seats booked</p>
                        </div>
                    </div>
                    <div className="mt-4 flex items-center text-gray-600 dark:text-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none" className="text-gray-600 dark:text-gray-100">
                        ...
                        <p className="ml-2 text-xs leading-3 text-gray-600 dark:text-gray-100">Veevents.com/cosutmeparty</p>
                        <svg className="ml-3.5 cursor-pointer text-gray-600 dark:text-gray-100" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
                    ...
                    <div className="flex items-center mt-4">
                        <button className="py-2 px-3 bg-gradient-to-br from-indigo-400 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 rounded-sm flex items-center">
                            ...
                            <p className="text-xs leading-3 text-white dark:text-gray-100 ml-1">Book a Seat</p>
                        </button>
                        <button className="py-2 ml-3 px-3 bg-gray-700 hover:bg-gray-600 ease-in duration-150 rounded-sm flex items-center">
                            ...
                            <p className="text-xs leading-3 text-white dark:text-gray-100 ml-1">Share Event</p>
                        </button>
                    </div>
                </div>
            </div>
