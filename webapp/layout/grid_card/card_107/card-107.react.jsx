            ...
            <div className="flex justify-center">
                <div className="max-w-sm rounded shadow bg-white dark:bg-gray-800">
                    <div>
                        <div className="flex justify-between py-4 px-6 md:py-6">
                            <div className="sm:flex items-center">
                                ...
                                <div className="sm:ml-5 ml-3">
                                    <p className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-100">TUK Design Inc.</p>
                                    <div className="flex items-center mt-1">
                                        <svg className="w-3 md:w-auto" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 30" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M12 9C10.7595 9 9.75 10.0095 9.75 11.25C9.75 12.4905 10.7595 13.5 12 13.5C13.2405 13.5 14.25 12.4905 14.25 11.25C14.25 10.0095 13.2405 9 12 9ZM12 16.5C9.105 16.5 6.75 14.145 6.75 11.25C6.75 8.355 9.105 6 12 6C14.895 6 17.25 8.355 17.25 11.25C17.25 14.145 14.895 16.5 12 16.5ZM12 0C5.3835 0 0 5.331 0 11.8845C0 20.0955 10.5735 29.253 11.0235 29.6385C11.3055 29.88 11.652 30 12 30C12.348 30 12.6945 29.88 12.9765 29.6385C13.4265 29.253 24 20.0955 24 11.8845C24 5.331 18.6165 0 12 0Z" fill="#6B7280" />
                                        </svg>
                                        <p className="sm:text-base text-sm text-gray-500 dark:text-gray-400 ml-2">Singapore</p>
                                    </div>
                                </div>
                            </div>
                            <svg className="mt-4 cursor-pointer w-4 md:w-auto" xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 46 11" fill="none">
                        ...
                        <p className="text-base md:text-lg px-6 font-bold text-gray-800 dark:text-gray-100 ">Product Designer</p>
                        <p className="text-sm md:text-base px-6 leading-5 text-gray-500 dark:text-gray-400 mt-2 md:mt-3">We are looking to hire a freelance UI/UX designer fluent in the use of Figma and invision studio.</p>
                    </div>
                        ...
                        <div className="sm:flex items-center justify-between">
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 36 36" fill="none">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M25.2 19.8H18C17.0064 19.8 16.2 18.9954 16.2 18V10.8C16.2 9.8046 17.0064 9 18 9C18.9936 9 19.8 9.8046 19.8 10.8V16.2H25.2C26.1954 16.2 27 17.0046 27 18C27 18.9954 26.1954 19.8 25.2 19.8ZM18 0C8.0748 0 0 8.0748 0 18C0 27.9252 8.0748 36 18 36C27.9252 36 36 27.9252 36 18C36 8.0748 27.9252 0 18 0Z" fill="#6B7280" />
                                </svg>
                            ...
                            <div className="flex items-center mt-4 sm:mt-0">
                                ...
                                <p className="text-base md:text-lg leading-4 text-gray-500 ml-4 dark:text-gray-400">2 years experience</p>
                            </div>
                        </div>
                    </div>
                </div>
