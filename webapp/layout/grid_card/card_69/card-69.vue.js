<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
      ...
      <script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>-->
            <div class="max-w-xs sm:max-w-sm w-full bg-white dark:bg-gray-800 rounded">
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col sm:pr-56 pr-10">
                            <p class="text-xs leading-3 text-gray-800 dark:text-gray-100">Goodbank</p>
                            <p class="text-xs font-semibold leading-3 pt-1 text-gray-500 dark:text-gray-100">USD</p>
                        </div>
                    ...
                    <p class="text-xs leading-3 text-gray-800 dark:text-gray-100 pt-6">Balance</p>
                    <p class="sm:text-3xl text-2xl font-semibold pt-1 leading-7 text-gray-800 dark:text-gray-100">$964.45</p>
                </div>
                <div>
                    <div>
                        <canvas id="myChart" width="250" height="190"></canvas>
                    </div>
                </div>
                <div class="p-4 flex items-center">
                    <div class="flex items-center">
                        ...
                        <p class="text-xs font-semibold leading-3 pl-2 text-gray-800 dark:text-gray-100">3455.30</p>
                    </div>
                    <div class="flex items-center pl-4">
                        ...
                        <p class="text-xs font-semibold leading-3 pl-2 text-gray-800 dark:text-gray-100">2840.00</p>
                    </div>
                </div>
            </div>
        </div>
