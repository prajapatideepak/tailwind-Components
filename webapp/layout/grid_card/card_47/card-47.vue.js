<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
        <div class="flex items-center justify-center w-full h-full py-8 px-4">
            <div class="sm:w-6/12 flex flex-wrap items-center rounded py-6 px-8">
                <div class="w-64 h-36 bg-white dark:bg-gray-800 rounded py-6 px-8 mt-4">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm leading-none text-gray-500 dark:text-gray-400">Total Users</p>
                            <p class="text-4xl font-semibold leading-9 pt-4 text-gray-800 dark:text-gray-100">40,699</p>
                        </div>

                        <div class="w-10 h-10 bg-blue-100 rounded flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="#0284C7" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="flex items-center pt-4">
                        ...
                        <p class="text-xs font-semibold leading-3 pl-2 text-green-600">5.2%</p>
                        <p class="text-xs font-medium leading-3 pl-1 text-gray-500 dark:text-gray-400">Up from Yesterday</p>
                    </div>
                </div>
                <div class="w-64 h-36 bg-white dark:bg-gray-800 rounded 2xl:mx-9 lg:mx-2 mt-4 py-6 px-8">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm leading-none text-gray-500 dark:text-gray-400">Total Users</p>
                            <p class="text-4xl font-semibold leading-9 pt-4 text-gray-800 dark:text-gray-100">40,699</p>
                        ...
                        <div class="w-10 h-10 bg-green-100 rounded flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M5 3V19H21V21H3V3H5ZM20.293 6.293L21.707 7.707L16 13.414L13 10.415L8.707 14.707L7.293 13.293L13 7.586L16 10.585L20.293 6.293Z" fill="#059669" />
                            </svg>
                        </div>
                    </div>
                    <div class="flex items-center pt-4">
                        ...
                        <p class="text-xs font-semibold leading-3 pl-2 text-red-600">2.6%</p>
                        <p class="text-xs font-medium leading-3 pl-1 text-gray-500 dark:text-gray-400">Up from Yesterday</p>
                    </div>
                </div>

                <div class="w-64 h-36 bg-white dark:bg-gray-800 rounded mt-4 px-8 py-6">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm leading-none text-gray-500 dark:text-gray-400">Total Users</p>
                            <p class="text-4xl font-semibold leading-9 pt-4 text-gray-800 dark:text-gray-100">40,699</p>
