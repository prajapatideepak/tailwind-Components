                ...
                <div className="sm:w-6/12 flex flex-wrap items-center  rounded py-6 px-8">
                    <div className="w-64 h-36 bg-white dark:bg-gray-800  rounded py-6 px-8 mt-4">
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm leading-none text-gray-500 dark:text-gray-400">Total Users</p>
                                <p className="text-4xl font-semibold leading-9 pt-4 text-gray-800 dark:text-gray-100">40,699</p>
                            </div>
                            <div className="w-10 h-10 bg-blue-100 rounded flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-users" width={24} height={24} viewBox="0 0 24 24" strokeWidth={2} stroke="#0284C7" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="flex items-center pt-4">
                            ...
                            <p className="text-xs font-semibold leading-3 pl-2 text-green-600">5.2%</p>
                            <p className="text-xs font-medium leading-3 pl-1 text-gray-500 dark:text-gray-400">Up from Yesterday</p>
                        </div>
                    </div>
                    <div
          ...
          mt-4  py-6 px-8"
                    >
                        ...
                        <div className="flex items-center pt-4">
                            ...
                            <p className="text-xs font-semibold leading-3 pl-2 text-red-600">2.6%</p>
                            <p className="text-xs font-medium leading-3 pl-1 text-gray-500 dark:text-gray-400">Up from Yesterday</p>
                        </div>
                    </div>
