    ...
    return (
        <>
            <div className="flex items-center justify-center w-full h-full py-12 px-4">
                <div className="max-w-sm w-full bg-white dark:bg-gray-800 shadow rounded px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="sm:text-2xl text-xl font-semibold leading-6 text-gray-800 dark:text-gray-100">12d 23hrs</p>
                            <p className="text-xs leading-3 text-gray-500 mt-1">To complete</p>
                        </div>
                        <div className="sm:ml-28">
                            <svg className="text-white dark:text-gray-800" xmlns="http://www.w3.org/2000/svg" width={55} height={55} viewBox="0 0 55 55" fill="none">
                    ...
                    <div className="mt-6">
                        <div>
                            <div className="flex items-center justify-between">
                                <p className="text-sm leading-3 text-gray-500 dark:text-gray-400">Tasks</p>
                                <p className="text-base leading-3 text-right text-gray-800 dark:text-gray-100">60%</p>
                            </div>
                        ...
                        <div className="mt-6">
                            <div className="flex items-center justify-between">
                                <p className="text-sm leading-3 text-gray-500 dark:text-gray-400">Budget</p>
                                <p className="text-base leading-3 text-right text-gray-800 dark:text-gray-100">$5600</p>
                            </div>
                            <div className="w-full h-1 bg-gray-200 rounded-full mt-4">
                        ...
                        <div className="mt-6">
                            <div className="flex items-center justify-between">
                                <p className="text-sm leading-3 text-gray-500 dark:text-gray-400">Hours</p>
                                <p className="text-base leading-3 text-right text-gray-800 dark:text-gray-100">320</p>
                            </div>
                            <div className="w-full h-1 bg-gray-200 rounded-full mt-4">
                    ...
                    <p className="text-xs font-semibold leading-3 text-indigo-700 mt-6">Manage project</p>
                </div>
            </div>
        </>
    );
