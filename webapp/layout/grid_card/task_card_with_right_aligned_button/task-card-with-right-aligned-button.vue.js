<template>
    <div class="mx-auto container dark:bg-gray-900 flex w-full justify-center items-center py-12">
        <div class="pt-4 md:flex justify-between w-10/12 border-t border-gray-400 dark:border-gray-200">
            ...
            <div class="mt-4 md:mt-0">
                <button class="text-sm text-white focus:outline-none py-3 px-6 bg-indigo-700 hover:bg-indigo-600 rounded-md">Save Task</button>
            </div>
        </div>
    </div>
</template>
