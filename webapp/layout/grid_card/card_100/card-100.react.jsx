                ...
                <div className="max-w-sm w-full relative rounded shadow bg-white dark:bg-gray-800">
                    <div className="absolute m-4 top-0 right-0">
                        <div className="flex items-center justify-center flex-1 h-full bg-gradient-to-tl from-yellow-300 to-red-400 shadow-inner rounded">
                            <p className="sm:text-lg text-base py-2 px-4 font-semibold leading-5 text-center text-white">Pets</p>
                        </div>
                    </div>
                    <img src="https://i.ibb.co/7bkVjbt/image2.png" alt="protest" />
                    <div className="py-6 px-6 flex md:items-center justify-between">
                        <div>
                            <p className="sm:text-lg text-base font-semibold leading-5 text-gray-800 dark:text-gray-100">Lorem ipsum dolor sit</p>
                            <p className="sm:text-base text-sm leading-4 pt-3 text-gray-500 dark:text-gray-400">Sed ut perspiciatis unde…</p>
                        </div>
                        <svg className="w-8 md:w-auto" xmlns="http://www.w3.org/2000/svg" width height viewBox="0 0 71 60" fill="none">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
