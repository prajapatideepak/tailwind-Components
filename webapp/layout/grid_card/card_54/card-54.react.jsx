            ...
            <div className="flex items-center justify-center w-full h-full py-8 px-4">
                <div className="max-w-md px-8 py-8 bg-gradient-to-tl from-indigo-500 to-purple-500 rounded-lg">
                    <div className="flex w-full items-center justify-between">
                        <p className="text-xl font-semibold leading-tight text-white">AlphaBank</p>
                    ...
                    <p className="text-base font-medium leading-3 text-white mt-16">Henry Richardson</p>
                    <p className="text-2xl font-semibold leading-4 text-white mt-4">4567 **** **** 4501</p>
                    <div className="flex items-center mt-10">
                        ...
                        <div className="flex items-center pl-24 sm:pl-48">
                            ...
                            <p className="text-sm font-semibold leading-3 text-white">mastercard</p>
                        </div>
                    </div>
                </div>
            </div>
