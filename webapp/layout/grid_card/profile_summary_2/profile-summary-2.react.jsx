                    ...
                    <div className="relative mt-8 border rounded border-gray-200 p-3 sm:p-5 2xl:flex items-center justify-between">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <img className="w-20 h-20 shadow rounded-full" src="https://cdn.tuk.dev/assets/templates/olympus/profile(1).png" />
                                <div className="ml-3">
                                    <p className="text-base font-medium leading-none text-gray-800">Miracle Geidt</p>
                                    <p className="text-xs leading-3 text-gray-500 mt-2">Sales Representative</p>
                                </div>
                            </div>
                        </div>
                        <div className="sm:flex items-center lg:items-start xl:items-center mt-4 2xl:mt-0">
                            <div className="md:flex items-center">
                                <div className="sm:flex items-center">
                                    <div className="whitespace-nowrap w-48 sm:w-auto p-3 bg-gray-100 rounded text-xs md:text-sm font-medium leading-4 text-gray-600">Email: miracle.g@gmail.com</div>
                                    <div className="p-3 bg-gray-100 w-48 sm:w-auto rounded text-xs md:text-sm font-medium leading-4 text-gray-600 sm:ml-4 mt-4 sm:mt-0">Phone: 856-768-0965</div>
                                </div>
                                <div className="flex flex-col items-start sm:flex-row sm:items-center mt-4 md:mt-0">
                                    <div className="p-3 bg-gray-100 rounded text-xs md:text-sm font-medium leading-4 text-gray-600 md:ml-4 w-48 sm:w-auto">Location: Prague, CZE</div>
                                    <button className="focus:outline-none px-6 py-3 bg-indigo-700 rounded text-xs md:text-sm font-medium leading-none text-white hover:opacity-80 mt-4 sm:mt-0 sm:ml-4 w-48 sm:w-auto">Chat</button>
                                </div>
                            </div>
                            <div className="absolute xl:relative xl:ml-4 right-0 top-0 mr-3 mt-3">
                                <button className="focus:outline-none mt-1" onClick={()=>setShow(!show)}>
                               ...
                               {show &&  <div className="dropdown-content bg-white shadow w-24 absolute z-30 right-0 mr-6  -ml-16 lg:-ml-10 xl:ml-0">
