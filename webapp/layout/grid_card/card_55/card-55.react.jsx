        ...
        <>
            <div className="flex items-center justify-center w-full h-full py-8 px-4">
                <div className="max-w-md py-6 pl-8 pr-8 sm:pr-24 bg-white dark:bg-gray-800 rounded">
                    <img className="w-24 h-24 rounded-full shadow" src="https://i.ibb.co/h7tHKRm/Photo.png" alt="profile" />
                    <p className="text-xl font-semibold leading-tight mt-2.5 text-gray-800 dark:text-gray-100">Delia Jimenez</p>
                    <p className="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">Bulgaria</p>
                    <div className="mt-7">
                        <div className="flex items-center">
                            <div>
                                <p className="text-xl font-semibold leading-tight text-green-600">100,345</p>
                                <p className="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">Followers</p>
                            </div>
                            <div className="ml-11">
                                <p className="text-xl font-semibold leading-tight  text-blue-600">1,765</p>
                                <p className="text-sm leading-3 mt-2 text-gray-500 dark:text-gray-400">Posts</p>
                            </div>
                        </div>
                        <div className="flex items-center mt-8">
                            <button className="flex items-center justify-center px-5 py-3 border hover:bg-indigo-700 text-sm leading-none text-center text-indigo-700 dark:text-white dark:bg-indigo-700 hover:text-white rounded border-indigo-700 dark:hover:text-indigo-700  dark:hover:bg-white">Add to list</button>
                            <div className="flex items-center ml-6">
                                ...
                                <svg className="ml-4" xmlns="http://www.w3.org/2000/svg" width={21} height={17} viewBox="0 0 21 17" fill="none">
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                                ...
                                <svg className="ml-4" xmlns="http://www.w3.org/2000/svg" width={19} height={20} viewBox="0 0 19 20" fill="none">
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
