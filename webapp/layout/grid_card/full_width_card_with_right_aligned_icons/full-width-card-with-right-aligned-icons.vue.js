<template>
    <div class="flex justify-center w-full dark:bg-gray-900 py-12">
        <div id="check" class="md:flex w-10/12 bg-white dark:bg-gray-800 shadow-lg items-center justify-between px-4 visible py-6">
            <div class="flex items-center text-gray-400">
                <svg @click="selection(false)" class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                    <circle cx="10" cy="10" r="10" stroke="currentColor"></circle>
                    <path d="M6 10.5H14" stroke="currentColor" stroke-linecap="square"></path>
                </svg>
                <p class="text-gray-900 dark:text-gray-100 text-base ml-3">1 notebook selected</p>
            </div>
            <div class="flex items-center mt-4 md:mt-0 dark:text-gray-400">
                <div class="mr-3">
