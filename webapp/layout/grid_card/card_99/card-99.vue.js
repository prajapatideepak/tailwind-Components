<template>
    <div class="bg-gray-200 dark:bg-gray-900 min-h-screen">
        <div class="flex justify-center py-12 sm:px-6 px-4">
            <div class="max-w-2xl p-4 f rounded shadow bg-white dark:bg-gray-800">
                <div class="flex flex-col lg:flex-row xl:items-center">
                    ...
                    <div class="pl-4 flex items-center justify-center">
                        <div class="sm:flex items-center justify-between">
                            <div class="flex flex-col items-start sm:mt-0 mt-4">
                                <p class="text-sm font-semibold leading-5 pr-14 text-gray-800 dark:text-gray-100">
                                    Creative Personnel (Graphics
                                    <br />Design / Digital Media)
                                </p>
                                <p class="text-xs leading-4 text-gray-500 dark:text-gray-400 pt-2"><span class="text-indigo-700 font-semibold">TUK Design Inc.</span>, 4 days ago</p>
                            </div>
                            <div class="pr-10 sm:mt-0 mt-2">
                                <p class="text-xs font-semibold leading-loose text-gray-500 dark:text-gray-400">Full Time</p>
                                <p class="text-sm leading-4 text-gray-800 dark:text-gray-100">
                                    In
                                    <span class="text-indigo-700">Austin, TX</span>
                                </p>
                            </div>
                            <div class="flex items-center justify-between sm:mt-0 mt-3">
                                <div class="w-16 mr-6 sm:ml-4 flex items-center justify-center bg-green-100 rounded-full">
                                    <p class="text-xs font-semibold leading-loose text-center text-green-700">DESIGN</p>
                                </div>
                                <svg class="text-gray-800 dark:text-gray-100" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 38 50" fill="none">
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
