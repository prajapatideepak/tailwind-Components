    ...
    return (
        <div>
            <div className="w-11/12 mx-auto mb-4 my-6 md:w-5/12 shadow sm:px-10 sm:py-6 py-4 px-4 bg-white dark:bg-gray-800 rounded-md">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 pb-3 font-normal">We are sorry to hear that you want to delete the account with us. If you have a different issue, please contact us.</p>
                <button className="focus:outline-none bg-red-400 transition duration-150 ease-in-out hover:bg-red-500 rounded text-white px-3 py-2 text-xs">Delete Account</button>
            </div>
        </div>
    );
};
