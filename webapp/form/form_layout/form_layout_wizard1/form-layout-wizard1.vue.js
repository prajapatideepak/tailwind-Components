<template>
  <body class="bg-gray-50 h-full mx-auto container">
    <div class="md:flex justify-between w-full">
      <div class="h-full relative">
        <div
          class="2xl:pl-20 pl-8 pt-8 lg:flex hidden items-center border-gray-200 border-b"
        >
          <div class="pb-7">
            <svg
              width="121"
          ...
          <div class="flex items-center 2xl:ml-24 ml-16">
            <p
              class="text-base font-bold border-b-2 pb-7 border-indigo-700 cursor-pointer mr-10 leading-4 text-indigo-700"
            >
              01.About you
            </p>
            <p
              class="text-base font-medium border-b-2 pb-7 border-transparent hover:border-indigo-700 cursor-pointer mr-10 leading-4 text-gray-800"
            >
              02.Position
            </p>
            <p
            ...
            <p
              class="text-base font-medium border-b-2 pb-7 border-transparent hover:border-indigo-700 cursor-pointer leading-4 text-gray-800"
            >
              05.Essay
            </p>
          </div>
        </div>
        <div class="2xl:p-20 p-8">
          <p
            class="md:w-96 md:text-3xl text-xl md:text-left text-center font-semibold leading-10 text-gray-800"
          >
            Select the category that best describe you.
          </p>
          <div
            class="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 items-center md:justify-start w-full justify-center"
          >
            <div
              class="flex flex-col items-center bg-white shadow rounded-lg py-10 px-14 relative"
            >
              <svg
                width="84"
                height="84"
              ...
              <p
                class="text-xl font-medium leading-5 mt-10 text-gray-800 text-center"
              >
                Teacher
              </p>
              <div
                class="w-10 h-10 bg-indigo-700 shadow rounded-tr rounded-br absolute top-0 right-0 flex items-center justify-center"
              >
                <svg
                  width="24"
                  height="24"
            ...
            <div
              class="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 md:mt-0 mt-4"
            >
              <svg
                width="84"
                height="84"
              ...
              <p
                class="text-xl font-medium leading-5 text-gray-800 mt-10 text-center"
              >
                Student
              </p>
            </div>
            ...
            <div
              class="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 xl:mt-0"
            >
              <svg
                width="84"
                height="84"
            ...
            <div
              class="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 2xl:mt-0"
            >
              <svg
                class="mt-1"
                width="84"
          ...
          <div
            class="md:flex hidden items-center w-full justify-between md:mt-10 xl:mt-44"
          >
            <button
              class="flex items-center p-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 hover:text-gray-500 text-gray-800"
            >
              <svg
                width="24"
                height="24"
              ...
              <span class="text-base font-medium leading-4 ml-3 text-center"
                >Back</span
              >
            </button>
            <button
              class="flex items-center bg-indigo-700 rounded p-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600"
            >
              <span
                class="text-base font-medium leading-4 pr-7 text-center text-white"
                >Conitnue</span
              >
              <svg
                width="24"
      ...
      <div
        class="bg-white md:w-72 h-full relative flex flex-col items-center justify-center w-full md:px-3 md:pt-0 pt-4 md:pb-24 pb-4 md:pt-40 lg:pt-0"
      >
        <div
          class="flex flex-col items-center md:mt-72 xl:mt-64 mt-12 justify-center"
        >
          <div
            class="mt- relative w-44 h-44 z-10 flex items-center h-full justify-center"
          >
            <canvas
              id="line_chart"
              ref="line_chart"
              ...
              class="relative z-10"
            ></canvas>
            <div class="absolute flex flex-col items-center z-0 justify-center">
              <p class="text-3xl font-semibold text-center text-gray-900">
                20%
              </p>
              <p class="text-base leading-4 pt-2 text-center text-gray-900">
                Completed
              </p>
            </div>
          </div>
        ...
        <div
          class="flex items-center justify-between md:mt-80 xl:mt-56 mt-12 px-8 w-full"
        >
          <p class="text-base font-medium leading-4 text-center text-gray-800">
            Step
          </p>
          <p class="text-base font-medium leading-4 text-center text-gray-800">
            2/5
      ...
      <div
        class="md:hidden flex items-center w-full justify-between py-10 px-4"
      >
        <button
          class="flex items-center p-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 hover:text-gray-500 text-gray-800"
        >
...
export default {
  mounted() {
    new Chart(this.$refs.line_chart, {
      type: "doughnut",
      data: {
