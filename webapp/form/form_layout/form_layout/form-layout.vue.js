    ...
    <div class="w-full bg-white p-10">
      <div class="md:flex items-center border-b pb-6 border-gray-200">
        <div class="flex items-center md:mt-0 mt-4">
          <div
            class="w-8 h-8 bg-indigo-700 rounded flex items-center justify-center"
          >
            <p class="text-base font-medium leading-none text-white">01</p>
          </div>
        ...
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          ...
          >
            <p class="text-base font-medium leading-none text-gray-800">02</p>
          </div>
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">
            Security Check
          </p>
        ...
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          <div
            class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center"
          >
            <p class="text-base font-medium leading-none text-gray-800">03</p>
          </div>
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">
            Confirm Info
          </p>
        ...
        <div class="flex items-center md:mt-0 mt-4 md:ml-12">
          <div
            class="w-8 h-8 bg-gray-100 rounded flex items-center justify-center"
          >
            <p class="text-base font-medium leading-none text-gray-800">04</p>
          </div>
          <p class="text-base ml-3 font-medium leading-4 text-gray-800">
            Onboarding
          </p>
      ...
      <p
        role="contentinfo"
        class="focus:outline-nonetext-sm font-light leading-tight text-gray-600 mt-4"
      >
      ...
      <div class="mt-12">
        <div class="py-4 flex items-center">
          ...
          <p class="text-sm leading-none ml-2">
            I agree with the
            <span class="text-indigo-700">terms of service</span>
          </p>
        </div>
      </div>
      <button
