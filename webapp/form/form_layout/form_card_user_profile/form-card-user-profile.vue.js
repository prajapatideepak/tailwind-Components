        ...
        <form id="form" v-on:submit.prevent>
            <div class="container mx-auto shadow bg-white dark:bg-gray-800 rounded">
                ...
                <div class="w-11/12 mx-auto">
                    <div class="xl:w-9/12 mx-auto xl:mx-0">
                        <div class="bg-center bg-cover bg-no-repeat rounded relative mt-8 h-48">
                            <img src="https://cdn.tuk.dev/assets/photo-1519252161722-1d52d47ac7df.jpg" alt="" class="w-full h-full object-cover overflow-hidden rounded shadow" />
                            <div class="flex bg-white dark:bg-gray-800 items-center px-3 py-2 shadow rounded absolute right-0 mr-4 mt-4 cursor-pointer top-0">
                            ...
                            <div class="w-20 h-20 rounded-full bg-cover bg-center bg-no-repeat absolute bottom-0 -mb-10 ml-12 shadow">
                                <img src="https://cdn.tuk.dev/assets/webapp/forms/form_layouts/form2.jpg" alt="" class="w-full h-full object-cover overflow-hidden absolute z-0 rounded-full shadow" />
                        ...
                        <div class="mt-16 flex flex-col xl:w-2/6 lg:w-2/6 w-full">
                            ...
                            <input type="text" id="username" name="username" class="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 text-gray-800 bg-transparent dark:text-gray-100" placeholder="@example" required />
                        </div>
                        <div class="mt-8 flex flex-col xl:w-3/5 lg:w-3/5 w-full">
                            ...
                            <textarea id="about" name="about" class="border border-gray-300 dark:border-gray-700 pl-3 py-2 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent resize-none text-gray-800 dark:text-gray-100" placeholder="Let the world know who you are" rows="5" required></textarea>
                ...
                <div class="w-full py-4 sm:px-12 px-4 bg-gray-100 dark:bg-gray-700 mt-6 flex justify-end rounded-bl rounded-br">
                    <button class="btn text-sm focus:outline-none text-gray-600 dark:text-gray-400 border border-gray-300 dark:hover:border-gray-500 py-2 px-6 mr-4 rounded hover:bg-gray-200 transition duration-150 ease-in-out">Restore</button>
