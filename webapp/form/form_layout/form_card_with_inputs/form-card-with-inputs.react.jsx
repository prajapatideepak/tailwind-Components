                                    ...
                                    <div className="xl:flex lg:flex md:flex flex-wrap justify-between">
                                      ...
                                      dark:text-gray-400 absolute right-0 bottom-0 top-0 mx-auto z-20 pointer-events-none "
                                        ...
                                        <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                                            ...
                                            <input type="text" id="Country" name="country" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none bg-transparent focus:border-indigo-700 text-gray-800 dark:text-gray-100" placeholder="California" />
                                        </div>
                                    </div>
                                    <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                                        ...
                                        <input type="text" id="State/Province" name="state" required className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none bg-transparent focus:border-indigo-700 text-gray-800 dark:text-gray-100" placeholder="California" />
                                    </div>
                                    <div className="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
                                        ...
                                        <input type="text" id="ZIP" name="zip" className="border border-red-400 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none bg-transparent focus:border-indigo-700 text-gray-800 dark:text-gray-100" placeholder="e.g 86745" />
