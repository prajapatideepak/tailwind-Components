            ...
            <div className="relative">
                ...
                {show && (
                    <ul className="visible transition duration-300 opacity-100 bg-white dark:bg-gray-800 shadow rounded mt-2 py-1 w-48 absolute">
                        <li className="text-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 font-bold text-sm leading-3 tracking-normal py-3 px-3">Display</li>
                        ...
                        <li className="text-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 font-bold text-sm leading-3 tracking-normal py-3 px-3">Account</li>
                        ...
                        <li className="text-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 font-bold text-sm leading-3 tracking-normal py-3 px-3">Alerts</li>
                        <li className="cursor-pointer text-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 font-normal">Notifications</li>
