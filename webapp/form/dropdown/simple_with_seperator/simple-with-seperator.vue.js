<template>
    <div class="mx-auto pt-6 pb-10">
        <div class="container flex justify-center mx-auto py-6">
            <div class="h-56 mb-32">
                <!-- Code block starts -->

                <div class="relative">
                    <div class="bg-white dark:bg-gray-800 flex justify-between border dark:border-gray-700 rounded w-40 cursor-pointer" data-menu>
                        <p class="pl-3 py-3 text-gray-600 dark:text-gray-400 text-sm leading-3 tracking-normal font-normal">Basic Options</p>
                        <div class="bg-white dark:bg-gray-800 items-center flex rounded-r border-gray-300 dark:border-gray-700 border-l">
                            <div class="text-gray-600 dark:text-gray-400 mx-3">
