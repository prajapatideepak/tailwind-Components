<template>
    <div class="mx-auto py-12 flex justify-center">
        ...
        <div class="flex items-center">
            ...
            <p class="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">On</p>
        </div>
        <!-- Code block ends -->
        <!-- Code block starts -->
        <div class="flex items-center ml-6">
            ...
            <p class="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Off</p>
        </div>
        <!-- Code block ends -->
        ...
        <div class="flex items-center ml-6">
            <div class="rounded-full w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                <input disabled type="radio" name="radio" class="checkbox appearance-none focus:outline-none border rounded-full border-gray-400 absolute cursor-pointer w-full h-full checked:border-none" />
                <div class="check-icon hidden border-4 border-indigo-700 rounded-full w-full h-full z-1"></div>
            </div>
            <p class="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Disabled</p>
        </div>
        <!-- Code block ends -->
    </div>
</template>
