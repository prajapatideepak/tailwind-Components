    ...
    return (
        <div className="mx-auto py-12 flex justify-center">
            ...
            <div className="flex items-center">
                ...
                <p className="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">On</p>
            </div>
            {/* Code block ends */}
            {/* Code block starts */}
            <div className="flex items-center ml-6">
                ...
                <p className="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Off</p>
            </div>
            {/* Code block ends */}
            {/* Code block starts */}
            <div className="flex items-center ml-6">
                ...
                <p className="ml-2 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Disabled</p>
            </div>
            {/* Code block ends */}
            <style>
                {`  .checkbox:checked {
