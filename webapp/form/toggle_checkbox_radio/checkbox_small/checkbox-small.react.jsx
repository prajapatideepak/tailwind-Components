        ...
        <div className="mx-auto py-12 flex justify-center">
            <div className="flex flex-col items-start">
                ...
                <div className="py-4 flex items-center">
                    ...
                    <p className="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Off</p>
                </div>
                {/* Code block ends */}
                {/* Code block starts */}
                <div className="py-4 flex items-center">
                    ...
                    <p className="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">On</p>
                </div>
                {/* Code block ends */}
                {/* Code block starts */}
                <div className="py-4 flex items-center">
                    <div className="bg-gray-200 border rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                    ...
                    <p className="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Disabled</p>
                </div>
                {/* Code block ends */}
                {/* Code block starts */}
                <div className="py-4 flex items-center">
                    ...
                    <p className="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Indeterminate</p>
                </div>
            </div>
            <style>
