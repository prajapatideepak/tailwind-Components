    ...
    <div class="mx-auto py-12 flex justify-center">
        <div class="flex flex-col items-start">
            ...
            <div class="py-4 flex items-center">
                ...
                <p class="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Off</p>
            </div>
            <!-- Code block ends -->
            <!-- Code block starts -->
            <div class="py-4 flex items-center">
                ...
                <p class="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">On</p>
            </div>
            <!-- Code block ends -->
            <!-- Code block starts -->
            <div class="py-4 flex items-center">
                <div class="bg-gray-200 border rounded-sm border-gray-400 dark:border-gray-700 w-4 h-4 flex flex-shrink-0 justify-center items-center relative">
                ...
                <p class="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Disabled</p>
            </div>
            <!-- Code block ends -->
            <!-- Code block starts -->
            <div class="py-4 flex items-center">
                ...
                <p class="ml-3 text-sm leading-4 font-normal text-gray-800 dark:text-gray-100">Indeterminate</p>
            </div>
        </div>
    </div>
</template>
