<template>
        ...
        <div>
            ...
            <div class="flex items-center mt-48 mb-4 px-8">
                <div class="w-10 h-10 bg-cover rounded-md mr-3">
                    <img :src="avatar" alt="" class="rounded-full h-full w-full overflow-hidden shadow" />
                </div>
                <div>
    ...
    <div class="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
        <div class="h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer" id="mobile-toggler" @click="sidebarHandler()">
...
<script>
export default {
    name: "WithSearchBarAndBottomControlsAndAvatar",
    data() {
        return {
            moved: true,
