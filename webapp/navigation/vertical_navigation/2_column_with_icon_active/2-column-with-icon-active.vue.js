        ...
        <div class="flex w-1/5">
            <div class="w-1/4 flex justify-center flex-col">
                ...
                <ul aria-orientation="vertical" class="rounded py-8">
                    <li class="cursor-pointer text-indigo-700 text-sm leading-3 tracking-normal pt-4 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                    ...
                    <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 pt-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                    ...
                    <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 pt-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                        <span class="text-gray-800">
