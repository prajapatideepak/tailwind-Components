<template>
  <body class="bg-white" style="height: 550px">
    ...
    <div class="">
      <div class="">
        <div
          ...
          "
        >
          <div class="h-16 w-full flex items-center px-4 lg:mt-7 md:mt-4">
            <svg
              width="191"
              height="34"
              viewBox="0 0 191 34"
          ...
          <ul class="mt-12">
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2 text-gray-800">Dashboard</span>
              </a>
            </li>
            <li
              class="
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2 text-sm leading-none"
                  >Transactions</span
                >
              </a>
              <svg
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2">Stats</span>
              </a>
              <svg
                width="16"
                height="16"
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2 leading-none">Partners</span>
              </a>
              <svg
                width="16"
                height="16"
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2 leading-none">Calendar</span>
              </a>
              <svg
                width="16"
                height="16"
            ...
            >
              ...
              >
                ...
                <span class="text-sm ml-2 leading-none">Settings</span>
              </a>
              <svg
                width="16"
                height="16"
          ...
          <div
            class="flex items-center lg:mt-48 md:mt-60 mb-4 px-4 border-t pt-5"
          >
      ...
      <nav class="md:hidden">
        ...
        >
          <div
            class="bg-white opacity-50 w-full h-full"
          ...
          >
            <div class="h-full md:hidden">
              <div class="flex flex-col justify-between h-full w-full">
                <div>
                  <div
                    class="mx-6 mt-6 flex w-full items-center justify-between"
                  >
                  ...
                  <ul class="mx-6">
                    <li>
                      <a class="cursor-pointer">
                        <div class="bg-gray-50 rounded text-gray-800 mt-10">
                          <div class="flex items-center">
                            <div class="w-6 h-6 md:w-8 md:h-8 text-gray-600">
                              <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                  ...
                  <div class="flex items-center mt-60 px-4 border-t pt-5">
                    <div class="w-10 h-10 bg-cover rounded-md mr-3">
                      <img
                        class="
                          rounded-full
