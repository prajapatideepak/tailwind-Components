...
export default function Index() {
    ...
    return (
        <div>
            ...
            <div id="Main" className={` ${show ? '-translate-x-full' : 'translate-x-0'} sm:absolute top-0 sm:z-20 bg-gray-50  ease-in-out transition transform  xl:translate-x-0 duration-500 flex justify-start items-start w-full sm:w-64    flex-col h-full`}>
                ...
                <div className="p-8  flex jusitf-start items-start flex-col space-y-2">
                    ...
                    <div className="flex justify-start items-start flex-col space-y-1">
                        <p className="cursor-pointer text-lg font-semibold leading-4  text-gray-800">Alexis Enache</p>
                        <p className="cursor-pointer text-xs leading-3 text-gray-600">Alpha Squad</p>
                    </div>
                </div>
                <div className="w-full px-6">
                    <hr className="border-gray-300  w-full" />
