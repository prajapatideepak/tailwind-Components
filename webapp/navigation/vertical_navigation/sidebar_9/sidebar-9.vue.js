<template>
    <body class="overflow-y-hidden overflow-x-hidden" style="height: 880px">
        <div class="bg-indigo-700 rounded-r shadow xl:hidden flex justify-between w-full p-6 items-center border-b border-transparent sm:border-gray-200">
            ...
            <div aria-label="toggler" class="flex justify-center items-center">
                <button id="open" ref="open" aria-label="open" @click="showNav(true)" class="hidden focus:outline-none focus:ring-2">
                ...
                <button id="close" ref="close" aria-label="close" @click="showNav(true)" class="focus:outline-none focus:ring-2">
                        <svg class="text-indigo-200" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="Main" ref="Main" class="bg-indigo-700 transform xl:translate-x-0 shadow xl:rounded-r fixed h-full top-0 sm:z-20 bg-white ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col">
