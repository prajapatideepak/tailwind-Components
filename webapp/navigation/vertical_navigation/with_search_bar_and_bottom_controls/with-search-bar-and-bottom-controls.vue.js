<template>
        ...
        <div class="px-8">
            ...
            <div class="flex justify-center mt-48 mb-4 w-full">
                <div class="relative">
                    ...
                    <input class="bg-gray-700 focus:outline-none rounded w-full text-sm text-gray-500 pl-10 py-2" type="text" placeholder="Search" />
                </div>
            </div>
        </div>
    ...
    <div class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
        <div class="h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer" id="mobile-toggler" @click="sidebarHandler()">
...
<script>
export default {
    name: "WithSearchBarAndBottomControls",
    data() {
        return {
            moved: true,
        };
