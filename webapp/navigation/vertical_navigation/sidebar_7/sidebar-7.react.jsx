...
export default function Index() {
    ...
    return (
        <div>
            ...
            <div id="Main" className={`${show ? '-translate-x-full' : 'translate-x-0'} bg-gray-50 pb-48 transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64  flex-col h-full`}>
