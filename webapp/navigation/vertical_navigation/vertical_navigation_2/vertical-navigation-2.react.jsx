        ...
        <>
            ...
            <div className="sm:flex h-full">
                        ...
                        <div className="mt-8 w-64">
                            <div>
                                <div className="border-l-4 border-indigo-700 py-2 cursor-pointer bg-gradient-to-r from-indigo-100 to-white flex items-center">
                                    ...
                                    <p className="text-sm leading-none  group-hover:text-indigo-700 text-indigo-700">Dashboard</p>
                                </div>
                            </div>
                            <div className="mt-4">
                                <div className="border-l-4 hover:border-indigo-700 border-transparent group py-2 cursor-pointer bg-gradient-to-r hover:from-indigo-100 hover:to-white flex items-center">
                                    ...
                                    <p className="text-sm leading-none text-gray-600 group-hover:text-indigo-700">Transactions</p>
                                </div>
                            </div>
                            <div className="mt-4">
                                <div className="border-l-4 hover:border-indigo-700 border-transparent group py-2 cursor-pointer bg-gradient-to-r hover:from-indigo-100 hover:to-white flex items-center">
                                    ...
                                    <p className="text-sm leading-none text-gray-600 group-hover:text-indigo-700">Stats</p>
                                </div>
                            </div>
                            <div className="mt-4">
                                <div className="border-l-4 hover:border-indigo-700 border-transparent group py-2 cursor-pointer bg-gradient-to-r hover:from-indigo-100 hover:to-white flex items-center">
                                    ...
                                    <p className="text-sm leading-none text-gray-600 group-hover:text-indigo-700">Partner</p>
                                </div>
                            </div>
                            <div className="mt-4">
                                <div className="border-l-4 hover:border-indigo-700 border-transparent group py-2 cursor-pointer bg-gradient-to-r hover:from-indigo-100 hover:to-white flex items-center">
                ...
                <div className="relative px-4 py-5 flex justify-between w-full sm:hidden">
                    {sideBar ? (
                        <button onClick={() => setsideBar(!sideBar)} aria-label="close nav bar" role="button" tabIndex={0} onkeypress="{sidebarHandler(false)}" className="right-0 mr-4 mt-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 absolute" id="cross" onclick="sidebarHandler(false)">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 6L6 18" stroke="#1F2937" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M6 6L18 18" stroke="#1F2937" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button>
                    ) : (
                        <button onClick={() => setsideBar(!sideBar)} aria-label="open nav bar" role="button" className="right-0 mr-4 mt-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 absolute " id="menu" onclick="sidebarHandler(true)">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
