    ...
    return (
        <>
            <div className="h-full w-full">
                {/* Code block starts */}
                <nav role="navigation" className="md:px-6 px-4  w-full mx-auto hidden md:block bg-indigo-700 shadow-md">
                    <div className="container bg-indigo-700 justify-between py-5 flex items-center md:items-stretch mx-auto border-b border-gray-200 border-opacity-20">
                        ...
                        <div className="h-full flex items-center justify-center lg:pr-40">
                            <div className="relative">
                                ...
                                <input className="hidden bg-indigo-50 bg-opacity-10 md:block focus:outline-none focus:border-indigo-700 lg:w-96 w-72 rounded text-sm text-indigo-50 pl-8 py-2 placeholder-indigo-50" type="text" placeholder="Search here" />
                            </div>
                        </div>
                        <div className="md:flex items-center justify-end hidden">
                            <div className="flex items-center">
                                <div className="h-full flex items-center">
                                    <button aria-label="show notifications" className="relative focus:outline-none hover:text-indigo-100 focus:text-indigo-100 text-indigo-50 mx-5 h-full flex items-center justify-center cursor-pointer">
                                ...
                                <div className="h-full flex items-center">
                                    <button aria-label="dropdown" className="focus:outline-none focus:text-gray-900 text-gray-800 hover:text-gray-900 w-full flex items-center justify-end relative cursor-pointer" onclick="dropdownHandler(this)">
                    ...
                    <div className="container py-4  justify-between flex items-center md:items-stretch mx-auto">
                        <div className="h-full flex items-center">
                            <ul className="pr-12 md:flex items-center h-full hidden">
                                <li>
                                    <a href="javascript:void(0)" className="focus:outline-none font-medium cursor-pointer h-full flex items-center hover:text-indigo-100 text-sm text-indigo-50 tracking-normal">
                                        Dashboard
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" className="focus:outline-none font-medium cursor-pointer h-full flex items-center hover:text-indigo-100 text-sm text-indigo-50 mx-6 tracking-normal">
                                        Transactions
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" className="focus:outline-none font-medium cursor-pointer h-full flex items-center hover:text-indigo-100 text-sm text-indigo-50 mr-6 tracking-normal">
                                        Stats
                                    </a>
                                </li>
                                <li>
                ...
                <nav className="md:hidden">
                    <div className="w-full shadow-md bg-indigo-700 fixed top-0 z-40">
                        <div className="w-full flex md:hidden">
                            <div className="py-4 flex  justify-between mx-4 items-center w-full">
                                <div aria-label="logo" role="img" tabIndex={0} className="focus:outline-none my-2">
                                ...
                                <div className="flex md:hidden items-center justify-end">
                                    <div className="flex items-center">
                                        <div className="h-full flex items-center">
                                            <button aria-label="show notifications" className="relative focus:outline-none focus:text-indigo-700 hover:text-indigo-700 focus:border-indigo-700 hover:border-indigo-700 h-full flex items-center justify-center text-gray-800 cursor-pointer">
                                                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    />
                                                    <path d="M9 17V18C9 18.7956 9.31607 19.5587 9.87868 20.1213C10.4413 20.6839 11.2044 21 12 21C12.7956 21 13.5587 20.6839 14.1213 20.1213C14.6839 19.5587 15 18.7956 15 18V17" stroke="#EEF2FF" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                                <div className="absolute top-0 left-4 mt-0 mr-4 pr-1 pt-1">
                                                    <div className="animate-ping w-2 h-2 rounded-full bg-blue-400" />
                                                </div>
                                        ...
                                        <div className="h-full flex items-center">
                                            <button aria-label="dropdown" className="focus:outline-none mx-4 focus:text-gray-900 text-gray-800 border-b-2 border-transparent focus:border-gray-800 hover:text-gray-900 w-full flex items-center justify-end relative cursor-pointer" onclick="dropdownHandler(this)">
                                                <img className="rounded-full h-10 w-10 object-cover" src="https://i.ibb.co/GTLTzZY/Unsplash-Avatars-0000s-0035-azamat-zhanisov-a5s-RFie-A3-BY-unsplash-1.png" alt="Unsplash-Avatars-0000s-0035-azamat-zhanisov-a5s-RFie-A3-BY-unsplash-1" />
                                            </button>
                                        </div>
                                        <div className="h-full flex items-center">
                                            <button  onClick={()=>setsideBar(!sideBar)} aria-label="open menu" className="focus:outline-none focus:ring-2 focus:ring-gray-700 rounded-md text-gray-800" onclick="sidebarHandler(true)">
                                                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M21 10H3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M21 6H3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M21 14H3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                    <path d="M21 18H3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div className={sideBar ? "absolute w-full h-full transform translate-x-0 z-40 transition duration-700 md:hidden":"absolute w-full h-full transform -translate-x-full z-40 transition duration-700 md:hidden"} id="mobile-nav">
                                    ...
                                    <div>
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="pb-4 flex items-center justify-between w-full">
                                                ...
                                                <button onClick={()=>setsideBar(!sideBar)} id="cross" aria-label="close menu" className="focus:outline-none focus:ring-2 rounded-md text-indigo-50" onclick="sidebarHandler(false)">
                                        ...
                                        <ul className>
                                            <div className="border-gray-200 border-b border-opacity-20 pb-5 md:pr-10 lg:pr-0 h-full flex items-center">
                                                <div className="relative w-full">
                                                    ...
                                                    <input className="md:hidden bg-indigo-50 bg-opacity-10 placeholder-indigo-50  focus:outline-none focus:border-indigo-700 w-80 rounded text-sm text-indigo-50 pl-12 py-2" type="text" placeholder="Search here" />
                                                </div>
                                            </div>
                                            <li>
                                                <a className="cursor-pointer">
                                                    <div className="text-gray-800 pt-5">
                                                        <div className="flex items-center">
                                                            <p tabIndex={0} className="focus:outline-none text-indigo-50 text-sm font-medium">
                                                                Dashboard
                                                            </p>
                                                        </div>
                                                    </div>
