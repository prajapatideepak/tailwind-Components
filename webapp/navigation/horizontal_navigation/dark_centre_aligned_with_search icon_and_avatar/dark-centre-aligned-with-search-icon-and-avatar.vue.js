<template>
    <nav class="w-full mx-auto bg-gray-800 shadow">
        <div class="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
            <div class="w-auto flex items-center">
                <div class="rounded-full relative p-3 flex justify-end text-gray-500 flex items-center relative">
            ...
            <ul class="flex items-center justify-center h-full">
                <li class="cursor-pointer h-full xl:flex items-center text-sm text-indigo-700 tracking-normal hidden">Dashboard</li>
                <li class="cursor-pointer h-full xl:flex items-center text-sm text-white ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Products</li>
                <li class="mx-0 lg:mx-12 cursor-pointer">
                ...
                <li class="cursor-pointer h-full xl:flex items-center text-sm text-white mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Performance</li>
                <li class="cursor-pointer h-full xl:flex items-center text-sm text-white tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Deliverables</li>
            </ul>
            <div class="h-full xl:flex items-center justify-end hidden relative cursor-pointer" @click="dropdownHandler($event)">
                <ul class="p-2 w-40 border-r bg-white absolute rounded xl:right-0 left-0 xl:left-auto shadow mt-16 top-0 hidden">
            ...
            <div class="visible xl:hidden xl:relative">
                <ul class="p-2 w-64 border-r bg-white absolute mt-20 top-0 -ml-2 rounded left-0 shadow mt-16 hidden">
                    <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <li class="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx="12" cy="12" r="9" />
                            <line x1="12" y1="17" x2="12" y2="17.01" />
                    ...
                    <li class="flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-settings" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                            <circle cx="12" cy="12" r="3" />
                ...
                <div class="flex items-center h-full">
                    <ul class="p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16 hidden">
                        ...
                        <li class="border-b border-gray-300 flex xl:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 pt-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                            <div class="flex items-center">
...
<script>
export default {
    name: "DarkCentreAlignedWIthSearchIconAndAvatar",
    data() {
        return {
