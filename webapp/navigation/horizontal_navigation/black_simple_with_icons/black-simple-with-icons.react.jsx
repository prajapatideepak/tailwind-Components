...
function Index() {
    return (
        <nav className="bg-gray-800 shadow">
            <div className="container mx-auto px-6 py-1 xl:py-0">
                <div className="relative flex items-center justify-between">
                    <div className="cursor-pointer inline-flex items-center justify-center rounded-md transition duration-150 ease-in-out">
                        <div className="xl:hidden flex items-center cursor-pointer py-6 mr-0 px-4 sm:px-10 md:border-l border-gray-700 text-gray-500 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out relative" onclick="dropdownHandler(this)">
                            <ul className="p-2 w-48 border-r bg-white  absolute mt-20 top-0 rounded left-0 shadow hidden">
                            ...
                            <p className="pl-1 hidden md:flex text-white">Menu</p>
                        </div>
                        <div className="hidden md:flex cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-r border-gray-700 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                    ...
                    <div className="hidden xl:flex items-center">
                        <div className="cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-gray-700 p-1 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                        ...
                        <div className="relative cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-r border-gray-700 p-1 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                        ...
                        <div className="ml-6 relative">
                            <div className="flex items-center relative" onclick="dropdownHandler(this)">
                                ...
                                <div className="cursor-pointer flex text-sm border-2 mr-2 border-transparent rounded focus:outline-none focus:border-gray-700 transition duration-150 ease-in-out">
                                ...
                                <p className="text-white text-sm">Jane Doe</p>
                            </div>
                        </div>
                    </div>
                </div>
