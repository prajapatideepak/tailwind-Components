<template>
    <nav class="bg-gray-800 shadow">
        <div class="container mx-auto px-6 py-1 xl:py-0">
            <div class="flex items-center justify-between">
                <div class="cursor-pointer inline-flex items-center justify-center rounded-md transition duration-150 ease-in-out">
                    <div class="xl:hidden flex items-center cursor-pointer py-6 mr-0 px-4 sm:px-10 md:border-l border-gray-700 text-gray-500 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                        <ul class="p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-20 hidden">
                        ...
                        <div @click="MenuHandler($event, false)" class="hidden close-m-menu h-6 w-6">
                        ...
                        <p class="pl-1 hidden md:flex text-white">Menu</p>
                    </div>
                    <!-- <div class="hidden md:flex cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-r border-gray-700 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out flex items-center relative">
                        <input type="text" class="bg-transparent focus:outline-none text-xs w-0 transition duration-150 ease-in-out"
                                placeholder="Type something...">
                        <svg @click="searchHandler($event)" xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-search cursor-pointer" width="28" height="28"
                    ...
                    <div class="hidden md:flex cursor-pointer py-6 mr-0 px-6 h-full sm:px-10 border-l border-r justify-center border-gray-700 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out flex items-center relative">
                        ...
                        <svg @click="searchHandler($event)" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z"></path>
                ...
                <div class="hidden xl:flex items-center">
                    <div class="cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-gray-700 p-1 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                    ...
                    <div class="relative cursor-pointer py-6 mr-0 px-4 sm:px-10 border-l border-r border-gray-700 p-1 text-gray-400 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                    ...
                    <div class="ml-6 relative">
                        <div class="flex items-center relative" @click="dropdownHandler($event)">
                            ...
                            <div class="cursor-pointer flex text-sm border-2 mr-2 border-transparent rounded focus:outline-none focus:border-gray-700 transition duration-150 ease-in-out">
                                <img class="rounded h-10 w-10 object-cover" src="https://tuk-cdn.s3.amazonaws.com/assets/components/horizontal_navigation/hn_1.png" alt="logo" />
                            </div>
                            <p class="text-white text-sm cursor-pointer">Jane Doe</p>
                        </div>
                    </div>
                </div>
            </div>
