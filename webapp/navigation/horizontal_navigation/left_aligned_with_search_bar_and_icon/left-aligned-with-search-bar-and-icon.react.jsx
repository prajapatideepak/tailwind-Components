                    ...
                    <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
                        <div className="h-full flex items-center">
                            ...
                            <ul className="pr-12 xl:flex items-center h-full hidden">
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-800 tracking-normal border-b-2 border-white">Dashboard</li>
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-800 mx-10 tracking-normal">Products</li>
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-800 mr-10 tracking-normal">Performance</li>
                                <li className="cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-800 tracking-normal">Deliverables</li>
                            </ul>
                        </div>
                            ...
                            <div className="w-full h-full flex items-center">
                                <div className="w-full pr-12 h-full flex items-center border-gray-300 border-r">
                                    <div className="relative w-full">
                                        ...
                                        <input className="border border-gray-300 focus:outline-none focus:border-indigo-700 w-56 rounded text-sm text-gray-800 bg-gray-700 pl-8 py-2" type="text" placeholder="Search" />
                                    </div>
                                </div>
