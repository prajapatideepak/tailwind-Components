        ...
        <div class="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
            <div class="h-full flex items-center">
                ...
                <ul class="pr-12 xl:flex items-center h-full hidden">
                    <li class="cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal border-b-2 border-indigo-700">Dashboard</li>
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gry-800 mx-10 tracking-normal">Products</li>
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gry-800 mr-10 tracking-normal">Performance</li>
                    <li class="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gray-800 tracking-normal">Deliverables</li>
                </ul>
            </div>
            <div class="h-full xl:flex items-center justify-end hidden">
                <div class="w-full h-full flex items-center">
                    ...
                    <div class="w-full h-full flex">
                        <div class="w-32 h-full flex items-center justify-center border-r text-gray-600 cursor-pointer">
            ...
            <div class="visible xl:hidden flex items-center cursor-pointer">
...
<script>
export default {
    name: "LeftAlignedWithSearchBarAndIcon",
    data() {
        return {
