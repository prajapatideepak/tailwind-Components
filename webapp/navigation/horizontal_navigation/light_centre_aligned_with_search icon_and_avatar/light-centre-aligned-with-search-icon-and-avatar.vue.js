    ...
    <nav class="w-full mx-auto bg-white shadow">
        <div class="container px-6 h-16 flex items-center justify-between mx-auto">
            <div class="flex items-center">
                <div class="rounded-full p-3 justify-end text-gray-500 flex items-center relative">
                    ...
                    <input type="text" class="absolute left-0 ml-10 bg-transparent focus:outline-none text-xs w-0 transition duration-150 ease-in-out" placeholder="Type something..." />
                </div>
            </div>
            <ul class="flex items-center justify-center h-full">
                <li class="cursor-pointer h-full hidden xl:flex items-center text-sm text-indigo-700 tracking-normal">Dashboard</li>
                <li class="cursor-pointer h-full hidden xl:flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gray-800 ml-10 tracking-normal">Products</li>
                <li class="cursor-pointer mx-0 lg:mx-12">
                ...
                <li class="cursor-pointer h-full hidden xl:flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gray-800 mr-10 tracking-normal">Performance</li>
                <li class="cursor-pointer h-full hidden xl:flex items-center text-sm hover:text-indigo-700 transition duration-150 ease-in-out text-gray-800 tracking-normal">Deliverables</li>
            </ul>
            <div class="h-full xl:flex hidden items-center justify-end relative cursor-pointer" @click="dropdownHandler($event)">
            ...
            <div class="visible xl:hidden items-center cursor-pointer">
...
<script>
export default {
    name: "LightCentreAlignedWIthSearchIconAndAvatar",
    data() {
        return {
