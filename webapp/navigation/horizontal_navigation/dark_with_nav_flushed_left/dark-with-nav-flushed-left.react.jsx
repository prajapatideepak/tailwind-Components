                    ...
                    <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
                        <div className="flex items-center">
                            <div className="mr-10 flex items-center">
                                ...
                                <h3 className="text-base text-white font-bold tracking-normal leading-tight ml-3 hidden xl:block">The North</h3>
                            </div>
                            <ul className="pr-32 xl:flex hidden items-center h-full">
                                ...
                                <li className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mx-10 tracking-normal relative text-white hover:text-indigo-700" onClick={() => setProduct(!product)}>
                                    {product && (
                                ...
                                <li className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mr-10 tracking-normal text-white hover:text-indigo-700">Performance</li>
                                <li className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white tracking-normal relative" onClick={() => setDeliverables(!deliverables)}>
                                    {deliverables && (
                                        <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                            <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                                            <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                                                    ...
                                                    {product && (
                                                        <div>
                                                            <ul className="my-3">
                                                                ...
                                                                <li className="text-white xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">Out of Stock</li>
                                                                <li className="text-white xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">New Products</li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                </li>
