        ...
        <div class="container px-6 h-16 flex justify-between items-center lg:items-stretch mx-auto">
            <div class="flex items-center">
                ...
                <ul class="hidden xl:flex items-center h-full">
                    <li class="cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal">
                        <span class="mr-2">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out mx-10 tracking-normal relative" @mouseenter="dropdownHandler($event)">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out mr-10 tracking-normal">
                        <span class="mr-2">
                    ...
                    <li class="cursor-pointer h-full flex items-center text-sm text-gray-800 hover:text-indigo-700 transition duration-150 ease-in-out tracking-normal relative" @mouseenter="dropdownHandler($event)">
                        <ul class="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute hidden top-0">
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Components</li>
            ...
            <div class="h-full hidden xl:flex items-center justify-end">
                <div class="h-full flex">
                    <div class="text-gray-600 px-6 h-full justify-center border-l border-gray-300 flex items-center">
                    ...
                    <div class="text-gray-600 w-20 h-full flex items-center justify-center border-l border-r border-gray-300 cursor-pointer">
                    ...
                    <div class="text-gray-600 w-20 h-full flex items-center justify-center border-r border-gray-300 cursor-pointer">
            ...
            <div class="visible xl:hidden flex items-center">
                <ul class="p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16 hidden">
                    ...
                    <li class="border-b border-gray-300 xl:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center" @click="dropdownHandler($event)">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-code" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z"></path>
