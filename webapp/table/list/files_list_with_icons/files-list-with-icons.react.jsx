            ...
            <div className="mx-auto container  px-6">
                <div className="mt-16">
                    <div className="flex pt-6 items-center">
                        <div className="cursor-pointer text-gray-900 dark:text-gray-100" onClick={() => setFile(!file)}>
                            {file ? (
                        ...
                        <h1 className="text-lg text-gray-900 dark:text-gray-100 font-semibold ml-3">Files</h1>
                    </div>
                    {file && (
                        <ul className="mt-8">
                            <div className="flex items-center w-full justify-between mt-8">
                                <div className="flex items-center pb-6 border-b border-gray-300 dark:border-gray-700 cursor-pointer w-full">
                                    ...
                                    <h4 className="text-xl text-gray-800 dark:text-gray-100 pl-4">Fonts.zip</h4>
                                </div>
                            ...
                            <div className="flex items-center w-full justify-between mt-6">
                                <div className="flex items-center pb-6 border-b border-gray-300 dark:border-gray-700 cursor-pointer w-full">
                                    ...
                                    <h4 className="text-xl text-gray-800 dark:text-gray-100 pl-4">Tasks list web app.sketch</h4>
                                </div>
                                <div className="relative">
                                    {edit == 1 && (
                                        <div className="mt-8 absolute left-0 -ml-24 shadow-md z-10  w-32">
                            ...
                            <div className="flex items-center w-full justify-between mt-6">
                                <div className="flex items-center pb-6 border-b border-gray-300 dark:border-gray-700 cursor-pointer w-full">
                                    ...
                                    <h4 className="text-xl text-gray-800 dark:text-gray-100 pl-4">Project file.psd</h4>
                                </div>
                                <div className="relative">
                                    {edit == 3 && (
                                        <div className="mt-8 absolute left-0 -ml-24 shadow-md z-10  w-32">
                            ...
                            <div className="flex items-center w-full justify-between mt-6">
                                <div className="flex items-center pb-6 border-b border-gray-300 dark:border-gray-700 cursor-pointer w-full">
                                    ...
                                    <h4 className="text-xl text-gray-800 dark:text-gray-100 pl-4">Symbols.sketch</h4>
                                </div>
                                <div className="relative">
                                    {edit == 4 && (
                                        <div className="mt-8 absolute left-0 -ml-24 shadow-md z-10  w-32">
