        ...
        <div class="w-full max-w-2xl px-4">
            <div class="border rounded-lg border pb-6 border-gray-200">
                <div class="flex items-center border-b border-gray-200 justify-between px-6 py-3">
                    <p tabindex="0" class="focus:outline-none text-sm lg:text-xl font-semibold leading-tight text-gray-800">Product Sales</p>
                    <button class="focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:bg-indigo-50 flex cursor-pointer items-center justify-center px-3 py-2.5 border rounded border-gray-100">
                        <p  class="focus:outline-none text-xs md:text-sm leading-none text-gray-600">Filter by: Latest</p>
                    </button>
                </div>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        ...
                                        <div class="pl-3">
                                            ...
                                            <p class="text-xs md:text-sm leading-none text-gray-600 mt-2">15’5. Core i5. FHD. Integrated graphics</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="pl-16">
                                    <div>
                                        <p class="text-sm font-semibold leading-none text-right text-gray-800">$2200</p>
                                        <div class="flex items-center justify-center px-2 py-1 mt-2 bg-green-100 rounded-full">
                                            <p class="text-xs leading-3 text-green-700">Shipped</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr tabindex="0" class="focus:outline-none">
                                <td class="pt-6">
                                    <div class="flex items-center">
                                        ...
                                        <div class="pl-3">
                                            <div class="flex items-center text-sm leading-none">
                                                <p class="font-semibold text-gray-800">Google Pixel 5</p>
                                                <p class="text-indigo-700 ml-3">(ID 879-10-940)</p>
                                            </div>
                                            <p class="text-xs md:text-sm leading-none text-gray-600 mt-2">15’5. Core i5. FHD. Integrated graphics</p>
                                        </div>
                                ...
                                <td class="pl-16 pt-6">
                                    <div>
                                        <p class="text-sm font-semibold leading-none text-right text-gray-800">$2200</p>
                                        <div class="flex items-center justify-center px-2 py-1 mt-2 bg-yellow-100 rounded-full">
                                            <p class="text-xs leading-3 text-yellow-700">Processing</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr tabindex="0" class="focus:outline-none">
                                <td class="pt-6">
                                    <div class="flex items-center">
                                        <div class="bg-gray-100 rounded-sm p-2.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                                <path d="M13.4167 3.5V13.4167H3.5V3.5H13.4167ZM13.4167 24.5H3.5V14.5833H13.4167V24.5ZM14.5833 3.5H24.5V13.4167H14.5833V3.5ZM24.5 14.5833V24.5H14.5833V14.5833H24.5Z" fill="#6B7280"></path>
                                            </svg>
                                        </div>
                                        <div class="pl-3">
                                            <div class="flex items-center text-sm leading-none">
                                                <p class="font-semibold text-gray-800">MS Surface 2019</p>
                                                <p class="text-indigo-700 ml-3">(ID 879-10-940)</p>
                                            </div>
                                            <p class="text-xs md:text-sm leading-none text-gray-600 mt-2">15’5. Core i5. FHD. Integrated graphics</p>
                                        </div>
