        ...
        <div className="bg-gray-800 py-6 lg:py-8">
            <div className="container px-6 mx-auto flex flex-col md:flex-row items-start md:items-center justify-between pb-4">
                ...
                <div className="mt-6 md:mt-0">
                    <button className="mr-3 bg-white transition focus:outline-none duration-150 ease-in-out rounded text-indigo-600 hover:bg-gray-300 px-5 py-2 text-sm">Back</button>
                    <button className="transition duration-150 focus:outline-none ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Edit Profile</button>
                </div>
            </div>
        </div>
    );
