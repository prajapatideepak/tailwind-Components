        ...
        <div className="container mx-auto w-5/6 sm:w-2/3 h-full">
            ...
            <div className="w-full bg-white dark:bg-gray-800 py-5 flex flex-col xl:flex-row items-start xl:items-center justify-between px-5 xl:px-10 shadow rounded-t">
                <div className="mb-4 sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 lg:w-1/2">
                    ...
                    <p className="font-normal text-sm text-gray-600 dark:text-gray-400 mt-1">Come work in an environment that allows you to learn alongside accomplished developers.</p>
                </div>
                <div className="lg:hidden w-full relative mt-2 md:mt-4">
                    ...
                    <select aria-label="Selected tab" className="focus:outline-none form-select block w-full p-3 border border-gray-300 rounded text-gray-600 dark:text-gray-400 appearance-none bg-transparent relative z-10">
