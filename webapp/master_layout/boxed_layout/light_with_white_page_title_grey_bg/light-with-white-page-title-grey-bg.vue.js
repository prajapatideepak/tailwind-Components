<template>
        ...
        <div class="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
            <div class="flex items-center">
                <div class="mr-10 flex items-center">
                    <svg aria-label="Home" id="logo" enable-background="new 0 0 300 300" height="44" viewBox="0 0 300 300" width="43" v-bind:xmlns="xmlns" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g>
                            <path
                                fill="#4c51bf"
                ...
                <ul class="pr-32 xl:flex hidden items-center h-full">
                    ...
                    <li class="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal relative" @click="dropdownHandler($event)">
                        ...
                        Products
                        <div class="ml-2">
                            <svg v-bind:xmlns="xmlns" class="icon icon-tabler icon-tabler-chevron-down" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="h-full flex items-center">
                    ...
                    <div class="w-full h-full flex">
                        ...
                        <div aria-haspopup="true" class="cursor-pointer w-full flex items-center justify-end relative" @click="dropdownHandler($event)">
                            ...
                            <img class="rounded-full h-10 w-10 object-cover" v-bind:src="profilePhoto" alt="avatar" />
    ...
    <div class="w-full pt-12 bg-gray-200">
        ...
        <div class="container mx-auto px-6 pb-10 h-64">
