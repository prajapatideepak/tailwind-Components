<template>
    <!-- Navigation starts -->
    <nav class="w-full mx-auto bg-gray-800 z-30 relative">
        <div class="container px-6 h-16 flex items-center justify-between mx-auto">
            <div class="flex items-center">
                <div class="rounded-full relative p-3 flex justify-end text-gray-500">
                    ...
                    <svg @click="searchHandler($event)" :xmlns="xmlns" class="cursor-pointer icon icon-tabler icon-tabler-search" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <li class="ml-2 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                        <div class="flex items-center">
                            ...
                            <div class="sm:ml-2 text-white relative">
                                <svg :xmlns="xmlns" class="icon icon-tabler icon-tabler-chevron-down cursor-pointer" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
    ...
    <div class="pt-8 pb-16 relative">
        ...
        <img class="z-10 w-full h-full absolute inset-0 object-cover" :src="titleImage" alt="bg" />
        ...
        <div class="z-10 relative container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
            ...
            <div class="mt-6 lg:mt-0">
                ...
                <button class="focus:outline-none transition duration-150 ease-in-out hover:bg-gray-200 border bg-white rounded text-indigo-500 px-8 py-2 text-sm">Edit Profile</button>
            </div>
        </div>
    </div>
    <!-- Page title ends -->
    <div class="w-full bg-gray-200 pb-8">
        <div class="container px-6 mx-auto">
            <div class="relative w-full">
                <!-- Remove class [ h-64 ] when adding a card block -->
                <div class="mx-auto -mt-8 h-64">
...
<script>
export default {
    name: "DarkWithBgImageInPageTitle",
    data() {
        return {
            xmlns: "http://www.w3.org/2000/svg",
            titleImage: "https://tuk-cdn.s3.amazonaws.com/assets/webapp/common/bg_image_dark.png",
