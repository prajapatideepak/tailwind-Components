                ...
                <div className="bg-indigo-100 w-full">
                    <div className="container px-6 py-6 sm:py-0 mx-auto">
                        ...
                        <ul className="hidden sm:flex flex-row pt-8">
                            ...
                            <li className="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">Earnings</li>
                            <li className="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">Forecasting</li>
