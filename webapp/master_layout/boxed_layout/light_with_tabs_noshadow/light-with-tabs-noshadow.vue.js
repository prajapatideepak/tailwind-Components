    ...
    <div class="bg-indigo-100 w-full">
        <div class="container px-6 py-6 sm:py-0 mx-auto">
            ...
            <ul class="hidden sm:flex flex-row pt-8">
                <div aria-haspopup="true" class="cursor-pointer flex items-center justify-end relative" @click="dropdownHandler($event)">
                    <li class="rounded-t w-32 h-12 flex items-center justify-start pl-4 lg:pl-0 lg:justify-center bg-indigo-200 text-sm text-indigo-700">
                        Dashboard
                        <span class="ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-down" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                        ...
                        <ul class="p-4 w-40 border-r bg-white absolute rounded z-40 left-0 shadow mt-48 hidden">
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                            <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Components</li>
                        </ul>
                ...
                <li class="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">Earnings</li>
                <li class="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">Forecasting</li>
                <div aria-haspopup="true" class="cursor-pointer flex items-center justify-end relative" @click="dropdownHandler($event)">
                    <li class="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">
                        Reports
                        <span class="ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-down" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
