<template>
    ...
    <nav class="w-full mx-auto bg-white shadow relative z-20">
        <div class="container px-6 h-16 flex items-center justify-between mx-auto">
            ...
            <ul class="flex items-center justify-center h-full">
                <li class="hover:text-indigo-700 cursor-pointer h-full hidden xl:flex items-center text-sm text-indigo-700 tracking-normal">Dashboard</li>
                <li class="hover:text-indigo-700 cursor-pointer h-full xl:flex hidden items-center text-sm text-gray-800 xl:ml-10 tracking-normal relative" @click="dropdownHandler($event)">
                    <ul class="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute hidden top-0">
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Components</li>
                    </ul>
                    Products
                </li>
                <li class="cursor-pointer mx-0 xl:mx-12">
                ...
                <li class="hover:text-indigo-700 cursor-pointer h-full hidden xl:flex items-center text-sm text-gray-800 mr-10 tracking-normal">Performance</li>
                <li class="hover:text-indigo-700 cursor-pointer h-full xl:flex hidden items-center text-sm text-gray-800 xl:mr-10 tracking-normal relative" @click="dropdownHandler($event)">
                    <ul class="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute hidden top-0">
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                        <li class="cursor-pointer text-gray-800 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Components</li>
            ...
            <div aria-haspopup="true" class="cursor-pointer h-full xl:flex hidden items-center justify-end relative" @click="dropdownHandler($event)">
    ...
    <div class="relative pt-8 pb-16">
        ...
        <img class="z-0 w-full h-full absolute inset-0 object-cover" :src="titleImage" alt="bg" />
    ...
    <div class="w-full bg-gray-200">
        <div class="container px-6 mx-auto">
            <div class="relative w-full">
                ...
                <div class="container mx-auto pb-10 h-64 -mt-8">
...
<script>
export default {
    name: "LightWithBgImageInPageTitle",
    data() {
        return {
