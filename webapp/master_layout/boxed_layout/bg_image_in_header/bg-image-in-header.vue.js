<template>
    <div class="relative">
        ...
        <img class="z-0 w-full h-full absolute inset-0 object-cover" :src="bgImage" alt="bg" />
        <!-- Background image ends -->
        <!-- Navigation starts -->
        <nav class="z-20 relative w-full mx-auto shadow">
            <div class="container px-6 h-16 flex items-center justify-between mx-auto">
                <div class="flex items-center">
                    <div class="rounded-full relative p-3 flex justify-end text-white">
                        ...
                        <svg @click="searchHandler($event)" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <ul class="flex items-start justify-center h-full">
                    <li class="py-6 border-b border-white pb-4 cursor-pointer font-bold xl:flex items-center text-sm text-white tracking-normal hidden">
                        <a class="">Dashboard</a>
                    </li>
                    <li class="hover:text-white py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 ml-0 xl:ml-10 tracking-normal hidden relative">Products</li>
                    <li class="mx-0 xl:mx-12 cursor-pointer h-full flex items-center">
                    ...
                    <li class="hover:text-white py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 mr-10 tracking-normal hidden">Performance</li>
                    <li class="hover:text-white py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 tracking-normal hidden">Deliverables</li>
                </ul>
                <div aria-haspopup="true" class="cursor-pointer h-full xl:flex items-center justify-end hidden relative" @click="dropdownHandler($event)">
                    ...
                    <div class="rounded">
                        <img class="rounded w-10 h-10 object-cover" :src="profilePhoto" alt="logo" />
                    </div>
                ...
                <div class="visible xl:hidden cursor-pointer">
        ...
        <!-- Navigation ends -->
        <!-- Page title starts -->
        <div class="z-10 relative pt-8 pb-16">
        ...
        <div class="container px-6 mx-auto">
            <div class="relative w-full">
                ...
                <div class="mx-auto -mt-8 h-64">
                    <div class="bg-white shadow rounded w-full h-full">
...
<script>
export default {
    name: "BgImageInHeader",
    data() {
        return {
            bgImage: "https://tuk-cdn.s3.amazonaws.com/assets/webapp/common/bg_image_dark.png",
