                ...
                <nav className="z-20 relative w-full mx-auto shadow">
                    <div className="container px-6 h-16 flex items-center justify-between mx-auto">
                        ...
                        <ul className="flex items-start justify-center h-full">
                            ...
                            <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 ml-0 xl:ml-10 tracking-normal hidden">Products</li>
                            ...
                            <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 mr-10 tracking-normal hidden">Performance</li>
                            <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 tracking-normal hidden">Deliverables</li>
                        </ul>
                        <div aria-haspopup="true" className="cursor-pointer h-full xl:flex items-center justify-end hidden relative">
                            <div className="rounded">
                                <img className="rounded w-10 h-10 object-cover" src="https://tuk-cdn.s3.amazonaws.com/assets/components/boxed_layout/bl_1.png" alt="logo" />
                            </div>
                            <div className="text-white ml-2" onClick={() => setProfile(!profile)}>
                ...
                <div className="container px-6 mx-auto">
                    <div className="relative w-full">
                        ...
                        <div className="mx-auto -mt-8 h-64">
                            <div className="bg-white shadow rounded w-full h-full">{/* Place your content here */}</div>
                        </div>
                    </div>
                </div>
            </div>
