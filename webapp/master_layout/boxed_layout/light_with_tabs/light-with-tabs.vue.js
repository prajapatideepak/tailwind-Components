    ...
    <div class="bg-gray-200 w-full">
        <div class="container px-6 py-6 sm:py-0 mx-auto">
            ...
            <ul class="hidden sm:flex flex-row pt-8">
                <li class="rounded-t w-32 h-12 flex items-center justify-center bg-white text-sm text-gray-800">Dashboard</li>
                <li class="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 mx-1 text-sm text-gray-800">Earnings</li>
                <li class="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 mr-1 text-sm text-gray-800">Forecasting</li>
                <li class="rounded-t w-32 h-12 flex items-center justify-center bg-gray-300 text-sm text-gray-800">Reports</li>
            </ul>
        </div>
    </div>
    <!-- Page title ends -->
