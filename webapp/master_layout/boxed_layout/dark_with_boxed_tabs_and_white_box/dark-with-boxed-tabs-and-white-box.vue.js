<template>
    ...
    <div class="bg-gray-200 pb-10">
        <nav class="w-full mx-auto bg-gray-800 shadow z-20 relative">
            <div class="container px-6 h-16 flex items-center justify-between mx-auto">
                ...
                <ul class="flex items-center justify-center h-full">
                    ...
                    <li class="hover:text-indigo-500 cursor-pointer h-full xl:flex items-center text-sm text-white ml-0 xl:ml-10 tracking-normal hidden relative" @click="dropdownHandler($event)">
        ...
        <!-- Navigation ends -->
        <!-- Page title starts -->
        <div class="bg-gray-800 pt-8 pb-16">
...
<script>
export default {
    name: "DarkWithBoxedTabsAndWhiteBox",
    data() {
        return {
