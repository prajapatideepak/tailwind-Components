            ...
            <div>
                    ...
                    <div className="container px-6 h-16 flex justify-between items-center xl:items-stretch mx-auto">
                        ...
                        <div className="w-full xl:w-auto h-full flex items-center justify-end">
                            <div className="h-full flex">
                                ...
                                <div aria-haspopup="true" className="cursor-pointer hidden xl:flex items-center pl-8 relative" onClick={() => setProfile(!profile)}>
                                    {profile ? (
                ...
                <div className="my-6 lg:my-8 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    ...
                    <div className="mt-6 lg:mt-0">
                        <button className="mx-2 my-2 bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 border border-gray-300 rounded text-indigo-700 px-6 py-2 text-sm">Back</button>
                ...
                <div className="w-full h-full py-12 bg-gray-200">
                    ...
                    <div className="container mx-auto px-6 h-64">
                        ...
                        <div className="flex w-full h-full flex-wrap rounded border-dashed border-2 border-gray-300">{/* Place your content here */}</div>
                    </div>
                </div>
            </div>
        </div>
