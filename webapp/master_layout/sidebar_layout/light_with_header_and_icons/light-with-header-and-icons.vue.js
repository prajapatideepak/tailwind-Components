<template>
    <div class="flex flex-no-wrap bg-gray-200">
        ...
        <div class="absolute border-r border-gray-100 sm:relative h-full bg-gray-100 z-20 p-4">
            <div class="flex w-full">
                <div class="w-1/4 flex justify-center flex-col w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-menu-2 cursor-pointer mt-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#718096" fill="none" stroke-linecap="round" stroke-linejoin="round" @click="sidebarHandler()">
                    ...
                    <ul aria-orientation="vertical" class="rounded py-8 mt-4">
                        <li class="cursor-pointer text-indigo-700 text-sm leading-3 tracking-normal py-1 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        ...
                        <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-1 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                        ...
                        <li class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-1 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                            <span class="text-gray-800">
                ...
                <div class="w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out" id="mobile-nav">
                    <div class="mt-2">
