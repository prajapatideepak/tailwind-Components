<template>
    <div class="flex flex-no-wrap bg-gray-200">
        ...
        <div class="w-64 absolute sm:relative bg-white shadow md:h-full flex-col justify-between hidden sm:flex pb-12">
            <div class="px-8">
        ...
        <div class="w-64 absolute z-40 bg-white shadow md:h-full flex-col justify-between sm:hidden pb-12 transition duration-150 ease-in-out" id="mobile-nav">
...
<script>
export default {
    name: "LightWithHeaderAndIndicator",
    data() {
        return {
            moved: true,
        };
