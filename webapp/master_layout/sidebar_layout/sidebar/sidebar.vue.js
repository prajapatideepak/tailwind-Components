<template>
  <body style="min-height: 318px">
    <div class="flex flex-no-wrap">
      <div class="absolute border-r sm:relative h-full z-20">
        <div class="flex w-full">
          <div
            class="flex items-center justify-center flex-col w-full py-6 px-3 bg-gray-100 h-full"
          >
            <svg
              width="51"
              height="32"
            ...
            <div aria-orientation="vertical" class="rounded py-10">
              <button
                class="cursor-pointer w-9 h-9 focus:bg-indigo-100 text-gray-600 focus:text-indigo-700 focus:ring-indigo-700 focus:ring-2 focus:ring-offset-2 focus:outline-none rounded flex items-center justify-center mb-4"                
              >
          ...
          <div
            class="flex justify-start flex-col transition duration-150 ease-in-out bg-white"
            id="mobile-nav"
          >
            <div
              class="flex items-center py-6 pr-12 pl-4 border-b cursor-pointer"              
            >
              <svg
                width="24"
                height="24"
              ...
              <span
                class="pl-2 text-base font-medium leading-none text-gray-800"
                >Overview</span
              >
            </div>
            <ul aria-orientation="vertical" class="rounded py-7 mx-4">
              <li class="cursor-pointer bg-indigo-100 py-1 rounded">
                <span
                  class="text-sm pl-2 py-2 font-medium leading-none text-indigo-700"
                  >Campaigns</span
                >
              </li>
              <li class="cursor-pointer py-1 mt-5">
                <span
                  class="text-sm pl-2 py-2 font-medium leading-none text-gray-600"
                  >Statistics</span
                >
              </li>
              <li class="cursor-pointer py-1 mt-5">
