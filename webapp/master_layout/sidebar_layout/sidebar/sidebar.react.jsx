                ...
                <div className="flex w-full">
                    <div className="flex items-center justify-center flex-col w-full py-6 px-3 bg-gray-100 h-full">
                        ...
                        <div aria-orientation="vertical" className="rounded py-10">
                            <button className="cursor-pointer w-9 h-9 focus:bg-indigo-100 text-gray-600 focus:text-indigo-700 focus:ring-indigo-700 focus:ring-2 focus:ring-offset-2 focus:outline-none rounded flex items-center justify-center mb-4" onClick={() => setsidebar(true)}>
                    ...
                    {sidebar && (
                        <div className="flex justify-start flex-col transition duration-150 ease-in-out bg-white">
                            <div className="flex items-center py-6 pr-12 pl-4 border-b cursor-pointer">
                                <svg onClick={() => setsidebar(false)} width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10.828 12L15.778 16.95L14.364 18.364L8 12L14.364 5.636L15.778 7.05L10.828 12Z" fill="#1F2937" />
                                </svg>
                                <span className="pl-2 text-base font-medium leading-none text-gray-800">Overview</span>
                            </div>
                            <ul aria-orientation="vertical" className="rounded py-7 mx-4">
                                <li className="cursor-pointer bg-indigo-100 py-1 rounded">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-indigo-700">Campaigns</span>
                                </li>
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-600">Statistics</span>
                                </li>
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-600">Favourites</span>
                                </li>
                                <li className="cursor-pointer py-1 mt-5">
                                    <span className="text-sm pl-2 py-2 font-medium leading-none text-gray-600">Workflows</span>
                                </li>
                            </ul>
                        </div>
                    )}
