<template>
    <div class="py-12 bg-gray-100">
        <!-- Code block starts -->
        <div id="alert" class="transition duration-150 ease-in-out absolute top-0 mt-12 w-full bg-yellow-400 shadow mb-8">
            <div class="container mx-auto xl:w-full lg:transition duration-150 ease-in-out w-11/12">
                <div class="w-full xl:flex lg:flex py-6 items-center">
                    <div class="xl:w-5/6 lg:w-5/6 w-full flex xl:flex-row lg:flex-row flex-col xl:justify-start lg:justify-start justify-center items-center">
                        ...
                        <p class="mx-4 text-lg text-white text-center sm:text-left">Hurricane warning in this area. Please check local media and authorities-NWS</p>
                    </div>
