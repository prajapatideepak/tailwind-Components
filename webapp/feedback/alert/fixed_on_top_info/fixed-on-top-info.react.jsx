...
const Index = () => {
    ...
    return (
        <div>
            {/* Code block starts */}
            <div className={flag ? "absolute top-0 mt-12 w-full bg-blue-400 shadow" : "absolute top-0 mt-12 w-full bg-blue-400 shadow translate-hide"}>
                <div className="container mx-auto xl:w-full lg:transition duration-150 ease-in-out w-11/12">
                    <div className="w-full xl:flex lg:flex py-6 items-center">
                        <div className="xl:w-5/6 lg:w-5/6 w-full flex xl:flex-row lg:flex-row flex-col justify-center items-center xl:justify-start lg:justify-start">
                            ...
                            <p className="mx-4 text-lg text-white text-center sm:text-left">We are providing you new offers. please check your email</p>
                        </div>
