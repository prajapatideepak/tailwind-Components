    ...
    return (
        <>
            <div className="mx-2 my-2 px-6 flex flex-wrap">
                ...
                <button className="mx-2 my-2 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6">Button</button>
