    ...
    return (
        <>
            <div className="px-6 flex items-center flex-no-wrap">
                ...
                <div className="w-12 h-12 bg-cover rounded-md -ml-2">
                    <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_4_3.png" alt className="h-full w-full overflow-hidden object-cover object-center rounded-full border-2 border-white dark:border-gray-700 shadow" />
                </div>
                <div className="w-12 h-12 bg-cover rounded-md -ml-2">
