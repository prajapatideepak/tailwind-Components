<template>
    <div class="mx-auto flex justify-center py-20 bg-gray-100">
        <div class="px-6 flex flex-col items-start sm:items-center sm:flex-row flex-wrap">
            <!-- Code block starts -->
            <div class="flex items-center mb-4 lg:mb-0 mr-10">
                <div class="w-12 h-12 bg-cover rounded-md mr-3">
                    <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_1.png" alt="" class="rounded h-full w-full overflow-hidden shadow" />
                </div>
                <div>
            ...
            <!-- Code block starts -->
            <div class="flex items-center mb-4 lg:mb-0 mr-10 relative cursor-pointer" @click="dropdownHandler($event, 1)">
                <ul class="p-2 w-40 border-r bg-white absolute rounded z-40 right-0 shadow mt-16 hidden top-0">
                ...
                <div class="w-12 h-12 bg-cover rounded mr-3">
                    <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_1.png" class="rounded h-full w-full overflow-hidden shadow" alt="" />
                </div>
                <div class="flex items-center">
                    <p class="text-gray-800 dark:text-gray-100 text-base font-medium">Steve Doe</p>
            ...
            <!-- Code block starts -->
            <div class="flex items-center mb-4 lg:mb-0 mr-10 relative cursor-pointer" @click="dropdownHandler($event, 2)">
                <ul class="p-2 w-40 border-r bg-white absolute rounded z-40 right-0 shadow mt-16 hidden top-0">
                    <li class="cursor-pointer text-gray-600 dark:text-gray-400 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<script>
export default {
    name: "AvatarRoundedWithDropdown",
    methods: {
