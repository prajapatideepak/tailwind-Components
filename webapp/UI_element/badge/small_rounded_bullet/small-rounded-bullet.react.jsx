    ...
    return (
        <>
            <div className="px-6 flex items-center sm:flex-row justify-between flex-wrap">
                ...
                <div className="border border-gray-300 dark:border-gray-700 h-6 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                ...
                <div className="bg-gray-200 dark:bg-gray-800 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-indigo-200 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                        <div className="h-1 w-1 rounded-full bg-indigo-700 mr-1" />
                ...
                <div className="bg-yellow-200 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-red-200 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-green-200 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-blue-200 h-6 w-20 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
