    ...
    return (
        <>
            <div className="px-6 flex items-center sm:flex-row justify-between flex-wrap">
                ...
                <div className="border border-gray-300 dark:border-gray-700 h-6 w-20 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                ...
                <div className="bg-gray-200 dark:bg-gray-800 h-6 w-20 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                ...
                <div className="bg-indigo-200 h-6 w-20 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                ...
                <div className="bg-green-200 h-6 w-20 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-green-500 font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for blue background badge starts */}
                <div className="bg-blue-200 h-6 w-20 mb-4 md:mb-0 rounded-md flex items-center justify-center">
