    ...
    return (
        <>
            <div className="px-6 flex items-center sm:flex-row justify-between flex-wrap">
                ...
                <div className="bg-gray-500 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for indigo background badge starts */}
                <div className="bg-indigo-700 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for yellow background badge starts */}
                <div className="bg-yellow-300 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for red background badge starts */}
                <div className="bg-red-400 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for green background badge starts */}
                <div className="bg-green-400 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
                {/* Code block for blue background badge starts */}
                <div className="bg-blue-400 h-8 w-24 mb-4 md:mb-0 rounded-md flex items-center justify-center">
                    <span className="text-xs text-white font-normal">Badge</span>
                </div>
                {/* Code block ends */}
            </div>
