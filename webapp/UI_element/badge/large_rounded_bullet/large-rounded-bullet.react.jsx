    ...
    return (
        <>
            <div className="px-6 flex items-center sm:flex-row justify-between flex-wrap">
                ...
                <div className="border border-gray-300 dark:border-gray-700 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                ...
                <div className="bg-gray-200 dark:bg-gray-800 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                        <div className="h-1 w-1 rounded-full bg-gray-600 dark:bg-gray-400 mr-1" />
                        <span className="text-xs text-gray-600 dark:text-gray-100 font-normal">Badge</span>
                    </div>
                </div>
                {/* Code block ends */}
                {/* Code block for indigo background badge starts */}
                <div className="bg-indigo-200 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                        <div className="h-1 w-1 rounded-full bg-indigo-700 mr-1" />
                ...
                <div className="bg-yellow-200 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-red-200 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-green-200 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
                ...
                <div className="bg-blue-200 h-8 w-24 mb-4 md:mb-0 rounded-full flex items-center justify-center">
                    <div className="flex items-center">
