        ...
        <>
            <div className="w-11/12 md:w-2/6 mx-auto">
                ...
                <div className="flex items-center">
                    ...
                    <div className="w-1/3 bg-indigo-700 h-2 mr-1" />
                    <div className="w-1/3 bg-gray-200 h-2 mr-1 relative">
                        <div className="absolute right-0">
                            <div className="relative bg-indigo-700 shadow-lg px-2 py-1 rounded mt-4">
                                ...
                                <p className="text-white text-xs font-bold">ETA: 3 mins</p>
                            </div>
                        </div>
                        <div className="h-2 w-2/6 bg-indigo-700" />
                    </div>
