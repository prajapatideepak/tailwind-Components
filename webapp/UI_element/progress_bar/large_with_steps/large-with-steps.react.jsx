    ...
    return (
        <>
            <div className="w-11/12 lg:w-2/6 mx-auto">
                <div className="bg-gray-200 h-2 flex items-center justify-between">
                    <div className="w-1/3 bg-indigo-700 h-2 flex items-center">
                    ...
                    <div className="w-1/3 flex justify-between bg-indigo-700 h-2 items-center relative">
                        <div className="absolute right-0 -mr-1">
                            <div className="relative bg-indigo-700 shadow-lg px-2 py-1 rounded mt-16 -mr-12">
                                <svg className="absolute top-0 -mt-1 w-full right-0 left-0" width="16px" height="8px" viewBox="0 0 16 8" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                    <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                        <g id="Progress-Bars" transform="translate(-322.000000, -198.000000)" fill="#667EEA">
                                ...
                                <p className="text-white text-xs font-bold">Step 3: Analyzing</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white h-6 w-6 rounded-full shadow flex items-center justify-center -mr-2">
