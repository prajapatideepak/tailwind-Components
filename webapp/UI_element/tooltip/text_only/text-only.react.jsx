        ...
        <>
            <div className="flex-col md:flex-row flex items-center md:justify-center">
                ...
                <div className="relative mt-20 md:mt-0" onMouseEnter={() => setTooltipStatus(1)} onMouseLeave={() => setTooltipStatus(0)}>
                    {tooltipStatus == 1 && (
                        <div role="tooltip" className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 absolute shadow-lg pt-4 pr-2 pl-3 pb-5 bg-white text-gray-600 rounded w-40">
                            <svg className="absolute bottom-0 -mb-2" width="16px" height="8px" viewBox="0 0 16 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <p className="text-xs text-gray-600 leading-4">This information will be used for personalization</p>
                        </div>
                    )}
                ...
                <div className="relative my-20 md:my-0 md:mx-40" onMouseEnter={() => setTooltipStatus(2)} onMouseLeave={() => setTooltipStatus(0)}>
                    {tooltipStatus == 2 && (
                        <div role="tooltip" className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 shadow-lg pt-4 pr-2 pl-3 pb-5 bg-indigo-700 text-gray-600 rounded w-40 absolute">
                            <svg className="absolute bottom-0 -mb-2" width="16px" height="8px" viewBox="0 0 16 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                            ...
                            <p className="text-xs text-white leading-4">This information will be used for personalization</p>
                        </div>
                    )}
                    <div className="mt-3 ml-2 cursor-pointer">
                        <svg aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-info-circle" width={25} height={25} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#A0AEC0" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="relative" onMouseEnter={() => setTooltipStatus(3)} onMouseLeave={() => setTooltipStatus(0)}>
                    {tooltipStatus == 3 && (
                        <div role="tooltip" className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 absolute shadow-lg pt-4 pr-2 pl-3 pb-5 bg-gray-800 text-gray-600 rounded w-40">
                            <svg className="absolute bottom-0 -mb-2" width="16px" height="8px" viewBox="0 0 16 8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
