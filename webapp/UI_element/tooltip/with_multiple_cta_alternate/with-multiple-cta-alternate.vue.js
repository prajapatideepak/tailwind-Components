<template>
    <div class="bg-gray-100 py-10 h-full w-full">
        <div class="container mb-12 mx-auto px-6 flex flex-col items-start pl-12 md:pl-0 md:items-center">
            ...
            <div class="flex-col md:flex-row flex items-center md:justify-center flex-wrap">
                <!--Code Block for white tooltip starts-->
                <div class="relative mt-20 md:mt-0" onmouseover="showTooltip(1)" onmouseout="hideTooltip(1)">
                    ...
                    <div id="tooltip1" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-white p-4 rounded">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-bold text-indigo-50 cursor-pointer">Learn More</span>
                            <button class="focus:outline-none bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-5 py-1 text-xs">Got it</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative my-28 md:my-0 md:mx-64" onmouseover="showTooltip(2)" onmouseout="hideTooltip(2)">
                    <div class="mr-2 cursor-pointer">
                        <svg aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-info-circle" width="25" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#A0AEC0" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx="12" cy="12" r="9" />
                    ...
                    <div id="tooltip2" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-indigo-700 p-4 rounded">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-bold text-white cursor-pointer">Learn More</span>
                            <button class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-indigo-700 px-5 py-1 text-xs">Got it</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative" onmouseover="showTooltip(3)" onmouseout="hideTooltip(3)">
                    <div class="mr-2 cursor-pointer">
                        <svg aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-info-circle" width="25" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#A0AEC0" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx="12" cy="12" r="9" />
                    ...
                    <div id="tooltip3" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-gray-800 p-4 rounded">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-bold text-white cursor-pointer">Learn More</span>
                            <button class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-gray-600 px-5 py-1 text-xs">Got it</button>
                        </div>
                    </div>
                </div>
